...
\devnote{A new mesh library is currently being developed for
  \dolfin{}. The new mesh library is currently available in the class
  \texttt{NewMesh}, which will replace the current class \texttt{Mesh}
  in \dolfin{} version 0.6.3, at which time this chapter will also be
