...
find_library(CHOLMOD_LIBRARIES cholmod PATHS $ENV{CHOLMOD_DIR} ${LIB_INSTALL_DIR})

if(CHOLMOD_LIBRARIES)

  get_filename_component(CHOLMOD_LIBDIR ${CHOLMOD_LIBRARIES} PATH)

  find_library(AMD_LIBRARY amd PATHS ${CHOLMOD_LIBDIR} $ENV{CHOLMOD_DIR} ${LIB_INSTALL_DIR})
  if (AMD_LIBRARY)
...
if(CHOLMOD_LIBRARIES)
  ...
  find_library(COLAMD_LIBRARY colamd PATHS ${CHOLMOD_LIBDIR} $ENV{CHOLMOD_DIR} ${LIB_INSTALL_DIR})
  if (COLAMD_LIBRARY)
...
if(CHOLMOD_LIBRARIES)
  ...
  find_library(CAMD_LIBRARY camd PATHS ${CHOLMOD_LIBDIR} $ENV{CHOLMOD_DIR} ${LIB_INSTALL_DIR})
  if (CAMD_LIBRARY)
...
if(CHOLMOD_LIBRARIES)
  ...
  find_library(CCOLAMD_LIBRARY colamd PATHS ${CHOLMOD_LIBDIR} $ENV{CHOLMOD_DIR} ${LIB_INSTALL_DIR})
  if (CCOLAMD_LIBRARY)
