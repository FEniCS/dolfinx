...
processes = CellFunction('size_t', mesh, MPI.process_number(mesh.mpi_comm()))
...
marker = CellFunction('bool', mesh, (MPI.process_number(mesh.mpi_comm()) == 0))
...
processes1 = CellFunction('size_t', mesh0, MPI.process_number(mesh.mpi_comm()))
file << processes1
...
# Create MeshFunction to hold cell process rank for refined mesh
processes2 = CellFunction('size_t', mesh1, MPI.process_number(mesh.mpi_comm()))
file << processes2
