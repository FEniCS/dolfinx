 ...
 * @date "2008-08-22"
 * @copyright "Copyright (C) 2008 Evan Lezar"
 *
 */
...
int main()
{
    ...
    {
        printf("Dominant mode found: %f\n", lr);
        if ( lc != 0 )
        {
            printf("WARNING:  Cutoff mode is complex (%f + i%f)\n", lr, lc);
        }
    }
    else
    {
        printf("ERROR:  Cutoff mode not found");
        return -1;
    }
