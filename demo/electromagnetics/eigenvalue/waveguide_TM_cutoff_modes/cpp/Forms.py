...
L = dot(v, u)*dx
compile([a, L, M, element], "Forms", {'language': 'dolfin', 'blas': False, 'form_postfix': True, 'precision': '15', 'split_implementation': False, 'quadrature_points': False, 'representation': 'tensor', 'optimize': False})
