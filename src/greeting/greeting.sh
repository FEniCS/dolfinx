...
echo "appreciated. Send any comments to dolfin@math.chalmers.se."
echo " "
...
echo " "
echo "This will send an email with the output of 'uname -a' to the above address. If"
echo "you are worried about the information you send, type 'uname -a' first to see"
echo "what it does. The output should be something like"
echo " "
