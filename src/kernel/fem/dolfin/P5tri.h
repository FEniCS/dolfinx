...
public:
  ...
  void nodemap(int nodes[], const Cell& cell, const Mesh& mesh) const
  {
    ...
    nodes[3] = offset + 4*cell.connections(1)[0] + edge_reordering_0[alignment][0];
    nodes[4] = offset + 4*cell.connections(1)[0] + edge_reordering_0[alignment][1];
    nodes[5] = offset + 4*cell.connections(1)[0] + edge_reordering_0[alignment][2];
    nodes[6] = offset + 4*cell.connections(1)[0] + edge_reordering_0[alignment][3];
    alignment = cell.edgeAlignment(1);
    nodes[7] = offset + 4*cell.connections(1)[1] + edge_reordering_0[alignment][0];
    nodes[8] = offset + 4*cell.connections(1)[1] + edge_reordering_0[alignment][1];
    nodes[9] = offset + 4*cell.connections(1)[1] + edge_reordering_0[alignment][2];
    nodes[10] = offset + 4*cell.connections(1)[1] + edge_reordering_0[alignment][3];
    alignment = cell.edgeAlignment(2);
    nodes[11] = offset + 4*cell.connections(1)[2] + edge_reordering_0[alignment][0];
    nodes[12] = offset + 4*cell.connections(1)[2] + edge_reordering_0[alignment][1];
    nodes[13] = offset + 4*cell.connections(1)[2] + edge_reordering_0[alignment][2];
    nodes[14] = offset + 4*cell.connections(1)[2] + edge_reordering_0[alignment][3];
