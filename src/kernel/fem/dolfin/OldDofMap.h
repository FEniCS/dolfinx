...
#ifndef __OLD_DOF_MAP_H
#define __OLD_DOF_MAP_H
...
namespace dolfin
{
  ...
  public:
    ...
    // FIXME: When UFC is in place, the OldDofMap constructor should takes as arguments
    // FIXME: one or more ufc::dof_map
    
    // FIXME: This should be removed
    /// Constructor
    OldDofMap(Mesh& mesh, const FiniteElement* element_0 = 0, const FiniteElement* element_1 = 0);

    /// Constructor
    OldDofMap(Mesh& mesh, const ufc::dof_map& dof_map);
