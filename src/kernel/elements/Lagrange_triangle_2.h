...
#ifndef __LAGRANGE_TRIANGLE_2_H
#define __LAGRANGE_TRIANGLE_2_H

#include <ufc.h>

/// This class defines the interface for a finite element.

class Lagrange_triangle_2_finite_element_0: public ufc::finite_element
{
public:

  /// Constructor
  Lagrange_triangle_2_finite_element_0() : ufc::finite_element()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~Lagrange_triangle_2_finite_element_0()
  {
    // Do nothing
  }
                              ...
                              const ufc::cell& c) const
  {
    ...
    static double X[6][3] = {{0, 0}, {1, 0}, {0, 1}, {0.5, 0.5}, {0, 0.5}, {0.5, 0}};
...
class Lagrange_triangle_2_dof_map_0: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  Lagrange_triangle_2_dof_map_0() : ufc::dof_map()
  {
    __global_dimension = 0;
  }

  /// Destructor
  virtual ~Lagrange_triangle_2_dof_map_0()
  {
    // Do nothing
  }
