...
namespace dolfin
{
  ...
  class BiCGSTAB : public Preconditioner, public LinearSolver
  {
  public:

    /// Create BiCGSTAB preconditioner/solver for a given matrix
    BiCGSTAB(const Matrix& A, real tol, unsigned int maxiter);
