...
namespace dolfin
{
  ...
  // uBlas dense matrix
  typedef ublas::matrix< double > ublas_dense_matrix_base;
  ...
  // uBlas sparse matrix
  typedef ublas::compressed_matrix<double, ublas::row_major> ublas_sparse_matrix_base;
