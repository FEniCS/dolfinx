...
class SwigDirector_GenericVector : public dolfin::GenericVector, public Swig::Director {

public:
    SwigDirector_GenericVector(PyObject *self);
    virtual void init(dolfin::uint N);
    virtual dolfin::uint size() const;
    virtual dolfin::real operator ()(dolfin::uint i) const;
    virtual ~SwigDirector_GenericVector();
    virtual void apply();
    virtual void zero();
    virtual dolfin::real get(int i);
    virtual void set(int i, dolfin::real value);
    virtual void set(dolfin::real const block[], int const pos[], int n);
    virtual void add(dolfin::real const block[], int const pos[], int n);
    virtual void get(dolfin::real block[], int const pos[], int n) const;
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        if (method == NULL) {
          std::string msg = "Method in class GenericVector doesn't exist, undefined ";
          msg += method_name;
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        method = PyObject_GetAttr(swig_get_self(), name);
        if (method == NULL) {
          std::string msg = "Method in class Function doesn't exist, undefined ";
          msg += method_name;
          Swig::DirectorMethodException::raise(msg.c_str());
        }
        vtable[method_index] = method;
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        method = PyObject_GetAttr(swig_get_self(), name);
        if (method == NULL) {
          std::string msg = "Method in class ODE doesn't exist, undefined ";
          msg += method_name;
          Swig::DirectorMethodException::raise(msg.c_str());
        }
        vtable[method_index] = method;
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        method = PyObject_GetAttr(swig_get_self(), name);
        if (method == NULL) {
          std::string msg = "Method in class BoundaryCondition doesn't exist, undefined ";
          msg += method_name;
          Swig::DirectorMethodException::raise(msg.c_str());
        }
        vtable[method_index] = method;
