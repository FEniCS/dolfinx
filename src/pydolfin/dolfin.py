...
class intp(_object):
    ...
    def __del__(self, destroy=_dolfin.delete_intp):
        """__del__(self)"""
        try:
...
class doublep(_object):
    ...
    def __del__(self, destroy=_dolfin.delete_doublep):
        """__del__(self)"""
        try:
            if self.thisown: destroy(self)
        except: pass
...
class uBlasVector(GenericVector,Variable):
    ...
    def axpy(*args):
        """axpy(self, real a, uBlasVector x)"""
        return _dolfin.uBlasVector_axpy(*args)

    def mult(*args):
        """mult(self, real a)"""
        return _dolfin.uBlasVector_mult(*args)

    def div(*args):
        """div(self, uBlasVector x)"""
        return _dolfin.uBlasVector_div(*args)
...
class BilinearForm(Form):
    ...
    def update(*args):
        """update(self, AffineMap map)"""
        return _dolfin.BilinearForm_update(*args)
...
class LinearForm(Form):
    ...
    def update(*args):
        """update(self, AffineMap map)"""
        return _dolfin.LinearForm_update(*args)
...
class NewMesh(Variable):
    ...
    def vertices(*args):
        ...
        vertices(self) -> real
        """
        return _dolfin.NewMesh_vertices(*args)
    ...
    def cells(*args):
        ...
        cells(self) -> uint
        """
        return _dolfin.NewMesh_cells(*args)
...
class FEM(_object):
    ...
    def assemble(*args):
        ...
        assemble(Functional M, Mesh mesh) -> real
        """
