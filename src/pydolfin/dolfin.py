...
class GenericVector(_object):
    ...
    def __init__(self, *args):
        """__init__(self) -> GenericVector"""
        if self.__class__ == GenericVector:
            args = (None,) + args
        else:
            args = (self,) + args
        this = _dolfin.new_GenericVector(*args)
        try: self.this.append(this)
        except: self.this = this
    ...
    def set(*args):
        ...
        set(self, int i, real value)
        """
        return _dolfin.GenericVector_set(*args)

    def __disown__(self):
        self.this.disown()
        _dolfin.disown_GenericVector(self)
