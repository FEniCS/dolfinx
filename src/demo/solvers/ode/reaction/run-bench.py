...
def run_set(method, solver, tolmax, k0, kmax, T, gamma):
    ...
    for tol in [tolmax, 0.5*tolmax, 0.1*tolmax, 0.05*tolmax]:
        ...
        output = getoutput("./dolfin-ode-reaction %s %s %e %e %e %e %e" % \
                           (method, solver, tol, k0, kmax, T, gamma))
...
run_set("cg",  "newton",      1e-3, 1e-2, 1e-2, 3.0, 100.0)
run_set("cg",  "fixed-point", 1e-3, 1e-2, 1e-2, 3.0, 100.0)
run_set("mcg", "newton",      1e-3, 1e-2, 1e-2, 3.0, 100.0)
run_set("mcg", "fixed-point", 1e-3, 1e-2, 1e-2, 3.0, 100.0)

# Run sets of benchmarks for gamma = 1000
run_set("cg",  "newton",      1e-6, 1e-5, 1e-3, 1.0, 1000.0)
run_set("cg",  "fixed-point", 1e-6, 1e-5, 1e-3, 1.0, 1000.0)
run_set("mcg", "newton",      1e-6, 1e-5, 1e-3, 1.0, 1000.0)
run_set("mcg", "fixed-point", 1e-6, 1e-5, 1e-3, 1.0, 1000.0)
