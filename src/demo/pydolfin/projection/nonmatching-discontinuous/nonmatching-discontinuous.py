...
# Projection demo between non-matching meshes, discontinuous Lagrange
...
# FIXME: The uBlas Krylov solver seems to have a problem with diagonal
# matrices, doesn't converge. Use lumping for now.
