...
namespace dolfin
{
  ...
  private:
    ...
    /// Assemble bilinear form for an element, interior boundary
    static void assembleElement(BilinearForm& a, GenericMatrix& A, 
                                const Mesh& mesh, const Cell& cell0, const Cell& cell1, AffineMap& map0,
                                AffineMap& map1, const int facetID0, const int facetID1);
