...
namespace dolfin
{
  ...
  public:
    ...
    /// Compute element matrix (interior boundary contribution)
    virtual void eval(real block[], const AffineMap& map0, const AffineMap& map1,
                      uint segment0, uint segment1) const = 0;
