...
void io(py::module& m)
{
  ...
  xdmf_file
      // Function
      .def("write",
           py::overload_cast<const dolfin::function::Function&, bool>(
               &dolfin::io::XDMFFile::write),
           py::arg("u"), py::arg("cell_centred"))
      .def("write",
           py::overload_cast<const dolfin::function::Function&, double, bool>(
               &dolfin::io::XDMFFile::write),
           py::arg("u"), py::arg("t"), py::arg("cell_centred"))
      // Mesh
      .def("write",
