...
namespace dolfin_wrappers
{
  ...
  void generation(py::module& m)
  {
    ...
    py::class_<dolfin::IntervalMesh, std::shared_ptr<dolfin::IntervalMesh>, dolfin::Mesh>(m, "IntervalMesh")
      ...
      .def(py::init([](const dolfin::MPICommWrapper comm, std::size_t n, double a, double b)
    ...
    py::class_<dolfin::RectangleMesh, std::shared_ptr<dolfin::RectangleMesh>, dolfin::Mesh>(m, "RectangleMesh")
      ...
      .def(py::init([](const dolfin::MPICommWrapper comm, const dolfin::Point& p0, const dolfin::Point& p1,
    ...
    py::class_<dolfin::UnitCubeMesh, std::shared_ptr<dolfin::UnitCubeMesh>, dolfin::Mesh>(m, "UnitCubeMesh")
      ...
      .def(py::init([](const dolfin::MPICommWrapper comm, std::size_t nx, std::size_t ny, std::size_t nz)
    ...
    py::class_<dolfin::UnitDiscMesh>(m, "UnitDiscMesh")
      .def_static("create", [](const dolfin::MPICommWrapper comm, std::size_t n, std::size_t degree, std::size_t gdim)
    ...
    py::class_<dolfin::SphericalShellMesh>(m, "SphericalShellMesh")
      .def_static("create", [](const dolfin::MPICommWrapper comm, std::size_t degree)
    ...
    py::class_<dolfin::UnitQuadMesh>(m, "UnitQuadMesh")
      ...
      .def_static("create", [](const dolfin::MPICommWrapper comm, std::size_t nx, std::size_t ny)
    ...
    py::class_<dolfin::UnitHexMesh>(m, "UnitHexMesh")
      ...
      .def_static("create", [](const dolfin::MPICommWrapper comm, std::size_t nx, std::size_t ny, std::size_t nz)
