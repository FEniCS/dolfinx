...
def generate_mesh_sphere_axis(radius_sph, radius_dom, radius_pml,
    ...
    if MPI.COMM_WORLD.rank == 0:
        ...
        gmsh.model.occ.addCircle(0, 0, 0, radius_sph*0.8, angle1 = -pi/2, angle2 = pi/2, tag=1)
        gmsh.model.occ.addCircle(0, 0, 0, radius_sph, angle1 = -pi/2, angle2 = pi/2, tag=2)
        gmsh.model.occ.addCircle(0, 0, 0, radius_dom*0.6, angle1 = -pi/2, angle2 = pi/2, tag=3)
        ...
        gmsh.model.addPhysicalGroup(1, [4], tag=scatt_tag)
