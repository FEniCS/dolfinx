...
# +
element = basix.create_element(basix.ElementFamily.P, basix.CellType.interval, 10, basix.LagrangeVariant.equispaced)
...
# +
element = basix.create_element(basix.ElementFamily.P, basix.CellType.interval, 10, basix.LagrangeVariant.gll_warped)
values = element.tabulate(0, pts)[0, :, :, 0]
...
ufl_element = basix.ufl.element(basix.ElementFamily.P, basix.CellType.triangle, 3, basix.LagrangeVariant.gll_warped)
