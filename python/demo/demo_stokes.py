...
np.testing.assert_allclose(norm_u_1, norm_u_0, rtol=1e-7)
np.testing.assert_allclose(norm_u_1, norm_u_0, rtol=1e-7)

# Solve using PETSc block matrices and an LU solver
norm_u_2, norm_p_2 = block_direct_solver()
np.testing.assert_allclose(norm_u_2, norm_u_0, rtol=1e-7)
np.testing.assert_allclose(norm_p_2, norm_p_0, rtol=1e-7)

# Solve using a non-blocked matrix and an LU solver
norm_u_3, norm_p_3 = mixed_direct()
np.testing.assert_allclose(norm_u_3, norm_u_0, rtol=1e-7)
