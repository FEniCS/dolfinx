...
def create_tnt_quad(degree):
    ...
    # Edges
    pts, wts = basix.quadrature.make_quadrature(basix.CellType.interval, 2 * degree)
    ...
    if degree == 1:
        ...
        pts, wts = basix.quadrature.make_quadrature(basix.CellType.quadrilateral, 2 * degree - 1)
