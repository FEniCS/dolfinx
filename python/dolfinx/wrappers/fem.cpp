  ...
  py::class_<dolfinx::fem::CoordinateElement,
      ...
      .def("push_forward",
           [](const dolfinx::fem::CoordinateElement& self,
             ...
             dolfinx::ndspan<const double, 2> _cell_geometry(
                 cell_geometry.data(), geom_shape);

             dolfinx::ndarray<double, 2> x(X_shape[0],
          ...
          [](dolfinx::fem::Function<PetscScalar>& self,
            ...
            auto _f = [&f](const dolfinx::ndarray<double, 2>& x)
              ...
              if (v.ndim() > 1)
              {
                ...
                dolfinx::ndarray<PetscScalar, 2> vals(v.shape()[0],
                                                      v.shape()[1]);
