...
void common(nb::module_& m)
{
  ...
  nb::class_<dolfinx::common::NeighbourhoodComms>(
      m, "NeighbourhoodComms",
      "Neighbourhood communicators for the communication pattern of an "
      "IndexMap, shared by the Scatterers built on the map.")
      .def(nb::init<const dolfinx::common::IndexMap&>(), nb::arg("index_map"));

  auto sc
      = nb::class_<dolfinx::common::Scatterer<>>(m, "Scatterer")
            .def(nb::init<std::shared_ptr<const dolfinx::common::IndexMap>,
                          std::shared_ptr<
                              const dolfinx::common::NeighbourhoodComms>>(),
                 nb::arg("index_map"), nb::arg("comms"))
            .def_prop_ro("index_map", &dolfinx::common::Scatterer<>::index_map)
            .def_prop_ro("comms", &dolfinx::common::Scatterer<>::comms)
            .def_prop_ro(
                "local_indices_block",
