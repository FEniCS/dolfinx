...
class LinearProblem():
    ...
    def __init__(self, a: ufl.Form, L: ufl.Form, bcs: typing.List[DirichletBCMetaClass] = [],
                 u: Function = None, petsc_options={}, form_compiler_parameters={}, jit_parameters={}):
        ...
        """
        self._a = create_form(a, form_compiler_parameters=form_compiler_parameters, jit_parameters=jit_parameters)
        self._A = create_matrix(self._a)

        self._L = create_form(L, form_compiler_parameters=form_compiler_parameters, jit_parameters=jit_parameters)
        ...
        if u is None:
            ...
            self.u = Function(a.arguments()[-1].ufl_function_space())
        else:
            self.u = u
