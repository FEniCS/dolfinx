...
class LinearProblem():
    ...
    def __init__(self, a: ufl.Form, L: ufl.Form, bcs: typing.List[DirichletBCMetaClass] = [],
                 u: Function = None, petsc_options={}, form_compiler_params={}, jit_params={}):
        ...
        form_compiler_params: Parameters used in FFCx compilation of
            ...
            values, except for `scalar_type` which is determined by
            DOLFINx.
        jit_params: Parameters used in CFFI JIT compilation of C
            code generated by FFCx. See `python/dolfinx/jit.py` for all
        ...
        """
        self._a = create_form(a, form_compiler_parameters=form_compiler_params, jit_parameters=jit_params)
        self._A = create_matrix(self._a)

        self._L = create_form(L, form_compiler_parameters=form_compiler_params, jit_parameters=jit_params)
...
class NonlinearProblem:
    ...
    F(u, v) = 0 for all v in V using PETSc as the linear algebra
    backend.
    ...
    def __init__(self, F: ufl.form.Form, u: Function, bcs: typing.List[DirichletBCMetaClass] = [],
        ...
        form_compiler_parameters: Parameters used in FFCx compilation of
            this form. Run `ffcx --help` at the commandline to see all
            available options. Takes priority over all other parameter
            values, except for `scalar_type` which is determined by
            DOLFINx.
        ...
        """
        self._L = create_form(F, form_compiler_parameters=form_compiler_params,
        ...
        self._a = create_form(J, form_compiler_parameters=form_compiler_params,
                              jit_parameters=jit_params)
        self.bcs = bcs
