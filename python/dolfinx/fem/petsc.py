...
class LinearProblem:
    ...
    def __init__(self, a: ufl.Form, L: ufl.Form, bcs: typing.List[DirichletBCMetaClass] = [],
                 u: _Function = None, petsc_options={}, form_compiler_opts={}, jit_opts={}):
        ...
        Args:
            ...
            jit_opts: Options used in CFFI JIT compilation of C
        ...
        """
        self._a = _create_form(a, form_compiler_opts=form_compiler_opts, jit_opts=jit_opts)
        self._A = create_matrix(self._a)

        self._L = _create_form(L, form_compiler_opts=form_compiler_opts, jit_opts=jit_opts)
...
class NonlinearProblem:
    ...
    def __init__(self, F: ufl.form.Form, u: _Function, bcs: typing.List[DirichletBCMetaClass] = [],
                 J: ufl.form.Form = None, form_compiler_opts={}, jit_opts={}):
        ...
        Args:
            ...
            form_compiler_opts: Options used in FFCx
        ...
        """
        self._L = _create_form(F, form_compiler_opts=form_compiler_opts,
                               jit_opts=jit_opts)
        ...
        self._a = _create_form(J, form_compiler_opts=form_compiler_opts,
                               jit_opts=jit_opts)
        self.bcs = bcs
