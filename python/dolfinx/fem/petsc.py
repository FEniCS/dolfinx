...
class LinearProblem():
    ...
    def __init__(self, a: ufl.Form, L: ufl.Form, bcs: typing.List[DirichletBCMetaClass] = [],
        ...
        """
        self._a = _create_form(a, form_compiler_parameters=form_compiler_params, jit_parameters=jit_params)
        self._A = create_matrix(self._a)

        self._L = _create_form(L, form_compiler_parameters=form_compiler_params, jit_parameters=jit_params)
...
class NonlinearProblem:
    ...
    def __init__(self, F: ufl.form.Form, u: _Function, bcs: typing.List[DirichletBCMetaClass] = [],
        ...
        Args:
            ...
            form_compiler_parameters: Parameters used in FFCx
                compilation of this form. Run ``ffcx --help`` at the
                commandline to see all available options.
            jit_parameters: Parameters used in CFFI JIT compilation of C
        ...
        """
        self._L = _create_form(F, form_compiler_parameters=form_compiler_params,
        ...
        self._a = _create_form(J, form_compiler_parameters=form_compiler_params,
                               jit_parameters=jit_params)
        self.bcs = bcs
