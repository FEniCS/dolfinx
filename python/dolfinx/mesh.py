...
def compute_midpoints(msh: Mesh, dim: int, entities: npt.NDArray[np.int32], num_threads: int = 1):
    ...
    """
    return _cpp.mesh.compute_midpoints(msh._cpp_object, dim, entities, num_threads)
