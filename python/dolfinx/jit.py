...
@mpi_jit_decorator
def ffcx_jit(ufl_object, form_compiler_opts={}, jit_opts={}):
    ...
    Args:
        ...
        form_compiler_opts: Options used in FFCx compilation of
            ...
            values.
        jit_opts: Options used in CFFI JIT compilation of C code
    ...
    """
    # Prepare form compiler options with priority options
    p_ffcx = ffcx.get_options(form_compiler_opts)
    p_jit = get_options(jit_opts)
