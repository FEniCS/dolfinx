...
def test_save_2d_vector_CG2(tempdir):
    points = np.array(
        [[0, 0], [1, 0], [1, 2], [0, 2], [1 / 2, 0], [1, 1], [1 / 2, 2], [0, 1], [1 / 2, 1]], dtype=default_real_type
    )
    points = np.array(
        [[0, 0], [1, 0], [0, 2], [0.5, 1], [0, 1], [0.5, 0], [1, 2], [0.5, 2], [1, 1]], dtype=default_real_type
    )
...
def test_triangle_perm_vtk():
    higher_order_triangle_perm = {
        ...
        28: np.array(
            [0, 1, 2, 8, 9, 10, 11, 12, 17, 16, 15, 14, 13, 3, 4, 5, 6, 7, 18, 21, 22, 19, 26, 27, 23, 25, 24, 20]
        ),
        36: np.array(
            [
                0,
