...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 10), // void()(double *, double const *, double const *, double const *, int const *, int const *)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 8), // double *
/*  2 */ _CFFI_OP(_CFFI_OP_POINTER, 8), // double const *
/*  3 */ _CFFI_OP(_CFFI_OP_NOOP, 2),
/*  4 */ _CFFI_OP(_CFFI_OP_NOOP, 2),
/*  5 */ _CFFI_OP(_CFFI_OP_POINTER, 9), // int const *
...
static void _cffi_d_tabulate_tensor_poissonA(double * x0, double const * x1, double const * x2, double const * x3, int const * x4, int const * x5)
{
  tabulate_tensor_poissonA(x0, x1, x2, x3, x4, x5);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_tabulate_tensor_poissonA(PyObject *self, PyObject *args)
{
  double * x0;
  double const * x1;
  double const * x2;
  ...
  if (!PyArg_UnpackTuple(args, "tabulate_tensor_poissonA", 6, 6, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5))
    return NULL;
  ...
  if (datasize != 0) {
    x4 = ((size_t)datasize) <= 640 ? (int const *)alloca((size_t)datasize) : NULL;
...
#else
#  define _cffi_f_tabulate_tensor_poissonA _cffi_d_tabulate_tensor_poissonA
#endif

static void _cffi_d_tabulate_tensor_poissonL(double * x0, double const * x1, double const * x2, double const * x3, int const * x4, int const * x5)
{
  tabulate_tensor_poissonL(x0, x1, x2, x3, x4, x5);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_tabulate_tensor_poissonL(PyObject *self, PyObject *args)
{
  double * x0;
  double const * x1;
  double const * x2;
  ...
  if (!PyArg_UnpackTuple(args, "tabulate_tensor_poissonL", 6, 6, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5))
    return NULL;
...
#else
#  define _cffi_f_tabulate_tensor_poissonL _cffi_d_tabulate_tensor_poissonL
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "tabulate_tensor_poissonA", (void *)_cffi_f_tabulate_tensor_poissonA, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_tabulate_tensor_poissonA },
  { "tabulate_tensor_poissonL", (void *)_cffi_f_tabulate_tensor_poissonL, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_tabulate_tensor_poissonL },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__cffi_kernelA(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__cffi_kernelA(void) { return NULL; }
#  else
     init_cffi_kernelA(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__cffi_kernelA(void)
{
  return _cffi_init("_cffi_kernelA", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_cffi_kernelA(void)
{
  _cffi_init("_cffi_kernelA", 0x2601, &_cffi_type_context);
}
#endif
