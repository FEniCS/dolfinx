...
def test_b_mesh_mapping(celltype):
    ...
    b_mesh, bndry_to_mesh = dolfinx.plot.create_boundary_mesh(mesh, MPI.COMM_SELF)
...
def test_b_mesh_orientation(celltype):
    ...
    b_mesh, bndry_to_mesh = dolfinx.plot.create_boundary_mesh(mesh, MPI.COMM_SELF, True)
