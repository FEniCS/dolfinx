...
def test_nth_order_triangle(order):
    ...
    if order == 1:
        ...
        points = np.array([[0.00000, 0.00000, 0.00000], [1.00000, 0.00000, 0.00000],
                           ...
                           [0.83333, 0.16667, -0.02778], [0.66667, 0.33333, 0.02778],
                           [0.50000, 0.50000, -0.02778], [0.33333, 0.66667, 0.02778],
                           [0.16667, 0.83333, -0.02778], [0.00000, 0.83333, -0.02778],
                           [0.00000, 0.66667, 0.02778], [0.00000, 0.50000, -0.02778],
                           [0.00000, 0.33333, 0.02778], [0.00000, 0.16667, -0.02778],
                           [0.16667, 0.16667, -0.02778], [0.66667, 0.16667, -0.02778],
                           [0.16667, 0.66667, 0.02778], [0.33333, 0.16667, -0.02778],
                           [0.50000, 0.16667, -0.02778], [0.50000, 0.33333, 0.02778],
                           [0.33333, 0.50000, -0.02778], [0.16667, 0.50000, -0.02778],
                           [0.16667, 0.33333, 0.02778], [0.33333, 0.33333, 0.02778]])
        ...
        points = np.array([[0.00000, 0.00000, 0.00000], [1.00000, 0.00000, 0.00000],
                           ...
                           [0.87500, 0.12500, -0.01562], [0.75000, 0.25000, 0.01562],
                           [0.62500, 0.37500, -0.01562], [0.50000, 0.50000, 0.01562],
                           [0.37500, 0.62500, -0.01562], [0.25000, 0.75000, 0.01562],
                           [0.12500, 0.87500, -0.01562], [0.00000, 0.87500, -0.01562],
                           [0.00000, 0.75000, 0.01562], [0.00000, 0.62500, -0.01562],
                           [0.00000, 0.50000, 0.01562], [0.00000, 0.37500, -0.01562],
                           [0.00000, 0.25000, 0.01562], [0.00000, 0.12500, -0.01562],
                           [0.12500, 0.12500, -0.01562], [0.75000, 0.12500, -0.01562],
                           [0.12500, 0.75000, 0.01562], [0.25000, 0.12500, -0.01562],
                           [0.37500, 0.12500, -0.01562], [0.50000, 0.12500, -0.01562],
                           [0.62500, 0.12500, -0.01562], [0.62500, 0.25000, 0.01562],
                           [0.50000, 0.37500, -0.01562], [0.37500, 0.50000, 0.01562],
                           [0.25000, 0.62500, -0.01562], [0.12500, 0.62500, -0.01562],
                           [0.12500, 0.50000, 0.01562], [0.12500, 0.37500, -0.01562],
                           [0.12500, 0.25000, 0.01562], [0.25000, 0.25000, 0.01562],
                           [0.50000, 0.25000, 0.01562], [0.25000, 0.50000, 0.01562],
                           [0.37500, 0.25000, 0.01562], [0.37500, 0.37500, -0.01562],
                           [0.25000, 0.37500, -0.01562]])
    ...
    V = FunctionSpace(mesh, ("CG", max(2, degree)))
    u = Function(V)
    cmap = fem.create_coordinate_map(mesh.ufl_domain())
    mesh.geometry.coord_mapping = cmap
    u.interpolate(e2)
