...
def test_ghost_connectivities(mode):
    ...
    reference = {}
    facet_mp = cpp.mesh.midpoints(meshR._cpp_object, tdim - 1, range(num_facets))
    cell_mp = cpp.mesh.midpoints(meshR._cpp_object, tdim, range(num_cells))
    ...
    facet_mp = cpp.mesh.midpoints(meshG._cpp_object, tdim - 1, range(num_facets))
    cell_mp = cpp.mesh.midpoints(meshG._cpp_object, tdim, range(num_cells))
