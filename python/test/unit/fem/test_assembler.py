...
def _equivalent_distinct_space_form_and_bc():
...
def test_assembly_rejects_bcs_for_equivalent_distinct_spaces():
    a, bc = _equivalent_distinct_space_form_and_bc()
    with pytest.raises(RuntimeError, match="equivalent but distinct test and trial spaces"):
...
class TestPETScAssemblers:
    ...
    def test_assembly_rejects_bcs_for_equivalent_distinct_spaces(self):
