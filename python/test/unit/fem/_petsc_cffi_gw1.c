...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__petsc_cffi_gw1(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__petsc_cffi_gw1(void) { return NULL; }
#  else
     init_petsc_cffi_gw1(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__petsc_cffi_gw1(void)
{
  return _cffi_init("_petsc_cffi_gw1", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_petsc_cffi_gw1(void)
{
  _cffi_init("_petsc_cffi_gw1", 0x2601, &_cffi_type_context);
}
#endif
