...
target_compile_options(
  ${PROJECT_NAME} PRIVATE $<$<BOOL:${HAVE_NO_MULTLINE}>:-Wno-comment>
)"""
...
def generate_cmake_files(subdirectory, generated_files):
    ...
    for root, dirs, files in os.walk(cwd + "/" + subdirectory):
        ...
        name_forms["compiler_flags"] = compiler_flags_str
        name_forms["compiler_flags_indented"] = textwrap.indent(compiler_flags_str, "  ")
