...
# {download}`demo_superlu_dist_solver/poisson.py`.  We begin by defining the finite
# element:
...
# functions on tetrahedrons (or in order words, continuous piecewise linear
# polynomials on tetrahedrons).
#
