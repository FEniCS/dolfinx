...
int main(int argc, char* argv[])
{
...

  {
    ...
    // b <- b - A * x_bc
    fem::set_bc<T, double>(ui->x()->mutable_array(), {bc}, T(-1));
    ...
    fem::set_bc<T, double>(b.mutable_array(), {bc}, T(0));
        ...
        = [&M, &ui, &bc, &coeff, &constants](la::Vector<T>& x, la::Vector<T>& y)
    {
      ...
      fem::set_bc<T, double>(y.mutable_array(), {bc}, T(0));
    ...
    fem::set_bc<T, double>(u->x()->mutable_array(), {bc}, T(1));
