                        ...
                        std::optional<std::int32_t> max_facet_to_cell_links = 2)
{
  ...
  return mesh::create_mesh(
      comm, comm, cells_span, std::span<const std::int32_t>(),
      coordinate_elements, comm, points_pruned, {(std::size_t)x_shape[0], gdim},
      part, mesh::GhostMode::none, max_facet_to_cell_links, 1);
}
} // namespace dolfinx::io::VTKHDF
