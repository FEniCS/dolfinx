                            ...
                            dolfinx::la::Vector<T>& u)
{
  ...
  const std::size_t m_loc = u.index_map()->size_local();
...
//-----------------------------------------------------------------------------
template class la::MUMPSLUSolver<float>;
template class la::MUMPSLUSolver<std::complex<float>>;
template class la::MUMPSLUSolver<double>;
template class la::MUMPSLUSolver<std::complex<double>>;
//-----------------------------------------------------------------------------
#endif
