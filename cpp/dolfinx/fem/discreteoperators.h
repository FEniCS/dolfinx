                       ...
                       auto&& mat_set)
{
  ...
  {
    stdex::mdspan<T, MDSPAN_IMPL_STANDARD_NAMESPACE::dextents<std::size_t, 2>> A(
                          ...
                          const FunctionSpace<U>& V1, auto&& mat_set)
{
  ...
  using mdspan2_t = stdex::mdspan<U, MDSPAN_IMPL_STANDARD_NAMESPACE::dextents<std::size_t, 2>>;
  using cmdspan2_t = stdex::mdspan<const U, MDSPAN_IMPL_STANDARD_NAMESPACE::dextents<std::size_t, 2>>;
  using cmdspan3_t = stdex::mdspan<const U, MDSPAN_IMPL_STANDARD_NAMESPACE::dextents<std::size_t, 3>>;
  using cmdspan4_t = stdex::mdspan<const U, MDSPAN_IMPL_STANDARD_NAMESPACE::dextents<std::size_t, 4>>;
  ...
  namespace stdex = std::experimental;
  using u_t = stdex::mdspan<U, MDSPAN_IMPL_STANDARD_NAMESPACE::dextents<std::size_t, 2>>;
  ...
  for (std::int32_t c = 0; c < num_cells; ++c)
  {
    ...
    {
      auto _u
          = stdex::submdspan(basis0, p, MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent, MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent);
      auto _U = stdex::submdspan(basis_reference0, p, MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent,
    ...
    {
      auto _u = stdex::submdspan(basis_values, p, MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent,
                                 MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent);
      auto _U = stdex::submdspan(mapped_values, p, MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent,
                                 MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent);
      auto _K = stdex::submdspan(K, p, MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent, MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent);
      auto _J = stdex::submdspan(J, p, MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent, MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent);
    ...
    {
      stdex::mdspan<T, MDSPAN_IMPL_STANDARD_NAMESPACE::dextents<std::size_t, 3>> A(
    ...
    else
    {
      ...
      {
        auto values = stdex::submdspan(mapped_values, MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent, i,
                                       MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent);
