                          ...
                          const FunctionSpace<U>& V1, auto&& mat_set)
{
  ...
  using cmdspan2_t = dolfinx::common::mdspan::mdspan<
      const U, dolfinx::common::mdspan::dextents<std::size_t, 2>>;
  using cmdspan3_t = dolfinx::common::mdspan::mdspan<
      const U, dolfinx::common::mdspan::dextents<std::size_t, 3>>;
  using cmdspan4_t = dolfinx::common::mdspan::mdspan<
      const U, dolfinx::common::mdspan::dextents<std::size_t, 4>>;
  ...
  for (std::int32_t c = 0; c < num_cells; ++c)
  {
    ...
    for (std::size_t p = 0; p < basis0.extent(0); ++p)
    {
      auto _u = MDSPAN_IMPL_STANDARD_NAMESPACE::submdspan(
          basis0, p, dolfinx::common::mdspan::full_extent,
          dolfinx::common::mdspan::full_extent);
      auto _U = MDSPAN_IMPL_STANDARD_NAMESPACE::submdspan(
          basis_reference0, p, dolfinx::common::mdspan::full_extent,
          dolfinx::common::mdspan::full_extent);
      auto _K = MDSPAN_IMPL_STANDARD_NAMESPACE::submdspan(
          K, p, dolfinx::common::mdspan::full_extent,
          dolfinx::common::mdspan::full_extent);
    ...
    {
      auto _u = MDSPAN_IMPL_STANDARD_NAMESPACE::submdspan(
          basis_values, p, dolfinx::common::mdspan::full_extent,
          dolfinx::common::mdspan::full_extent);
      auto _U = MDSPAN_IMPL_STANDARD_NAMESPACE::submdspan(
          mapped_values, p, dolfinx::common::mdspan::full_extent,
          dolfinx::common::mdspan::full_extent);
      auto _K = MDSPAN_IMPL_STANDARD_NAMESPACE::submdspan(
          K, p, dolfinx::common::mdspan::full_extent,
          dolfinx::common::mdspan::full_extent);
    ...
    else
    {
      for (std::size_t i = 0; i < mapped_values.extent(1); ++i)
      {
        auto values = MDSPAN_IMPL_STANDARD_NAMESPACE::submdspan(
            mapped_values, dolfinx::common::mdspan::full_extent, i,
            dolfinx::common::mdspan::full_extent);
