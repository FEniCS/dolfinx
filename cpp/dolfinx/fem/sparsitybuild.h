...
/// @param[in] cells Cells to index into each dofmap.
/// cells[i] is a list of (cell0, cell1) pairs for each interior facet to index
/// into dofmap[i]. cells[0] and cells[1] must have the same size.
Cells as `(cell0, cell1)` pairs (row-major) for
/// each facet.
