    ...
    std::span<const std::int8_t> bc_markers1, std::span<const T> x0, T scale)
{
  ...
  for (std::size_t index = 0; index < cells.size(); ++index)
  {
    ...
    auto dmap1 = MDSPAN_IMPL_STANDARD_NAMESPACE::MDSPAN_IMPL_PROPOSED_NAMESPACE::submdspan(dofmap1, c,
    ...
    auto x_dofs = MDSPAN_IMPL_STANDARD_NAMESPACE::MDSPAN_IMPL_PROPOSED_NAMESPACE::submdspan(x_dofmap, c,
                                   MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent);
    ...
    auto dmap0 = MDSPAN_IMPL_STANDARD_NAMESPACE::MDSPAN_IMPL_PROPOSED_NAMESPACE::submdspan(dofmap0, c,
                                  MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent);
    ...
    std::span<const std::int8_t> bc_markers1, std::span<const T> x0, T scale)
{
  ...
  for (std::size_t index = 0; index < facets.size(); index += 2)
  {
    ...
    // Get dof maps for cell
    auto dmap1 = MDSPAN_IMPL_STANDARD_NAMESPACE::MDSPAN_IMPL_PROPOSED_NAMESPACE::submdspan(dofmap1, cell,
                                  MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent);
    ...
    // Get cell coordinates/geometry
    auto x_dofs = MDSPAN_IMPL_STANDARD_NAMESPACE::MDSPAN_IMPL_PROPOSED_NAMESPACE::submdspan(x_dofmap, cell,
                                   MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent);
    for (std::size_t i = 0; i < x_dofs.size(); ++i)
    {
      std::copy_n(std::next(x.begin(), 3 * x_dofs[i]), 3,
    ...
    // Size data structure for assembly
    auto dmap0 = MDSPAN_IMPL_STANDARD_NAMESPACE::MDSPAN_IMPL_PROPOSED_NAMESPACE::submdspan(dofmap0, cell,
                                  MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent);
    ...
    std::span<const T> x0, T scale)
{
  ...
  for (std::size_t index = 0; index < facets.size(); index += 4)
  {
    ...
    // Get cell geometry
    auto x_dofs0 = MDSPAN_IMPL_STANDARD_NAMESPACE::MDSPAN_IMPL_PROPOSED_NAMESPACE::submdspan(
    ...
    auto x_dofs1 = MDSPAN_IMPL_STANDARD_NAMESPACE::MDSPAN_IMPL_PROPOSED_NAMESPACE::submdspan(
    ...
    std::span<const std::uint32_t> cell_info)
{
  ...
  for (std::size_t index = 0; index < cells.size(); ++index)
  {
    ...
    auto dofs = MDSPAN_IMPL_STANDARD_NAMESPACE::MDSPAN_IMPL_PROPOSED_NAMESPACE::submdspan(dofmap, c,
                                 MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent);
    if constexpr (_bs > 0)
    {
    ...
    std::span<const std::uint32_t> cell_info)
{
  ...
  for (std::size_t index = 0; index < facets.size(); index += 2)
  {
    ...
    auto dofs = MDSPAN_IMPL_STANDARD_NAMESPACE::MDSPAN_IMPL_PROPOSED_NAMESPACE::submdspan(dofmap, cell,
                                 MDSPAN_IMPL_STANDARD_NAMESPACE::full_extent);
    if constexpr (_bs > 0)
    {
      for (std::size_t i = 0; i < dofs.size(); ++i)
