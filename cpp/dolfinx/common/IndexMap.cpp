                       ...
                       IndexMapOrder order, bool allow_owner_change)
{
  ...
  submap_src.erase(std::ranges::unique(submap_src).begin(), submap_src.end());
                              ...
                              const IndexMap& map)
{
  ...
  recv_buffer.erase(std::ranges::unique(recv_buffer).begin(),
                    recv_buffer.end());
...
std::vector<std::int32_t> IndexMap::shared_indices() const
{
  ...
  shared.erase(std::ranges::unique(shared).begin(), shared.end());
