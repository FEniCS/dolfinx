...
private:
  ...
  IndexMapNew(std::array<std::int64_t, 2> local_range, std::size_t size_global,
...
public:
  ...
  /// IndexMapNew::scatter_fwd_end. The send and receive buffer should not
  /// be changed until after IndexMapNew::scatter_fwd_end has been called.
  ///
  ...
  /// be changed until after a call to IndexMapNew::scatter_fwd_end. The
  /// order of data in the buffer is given by
  /// IndexMapNew::scatter_fwd_indices.
  ...
  /// IndexMapNew::scatter_fwd_ghost_positions. The buffer must not be
  /// accessed or changed until after a call to
  /// IndexMapNew::scatter_fwd_end.
  template <typename T>
  ...
  /// communication started by IndexMapNew::scatter_fwd_begin.
  ///
  ...
  /// IndexMapNew::scatter_rev_end. A reverse scatter is the transpose of
  /// IndexMapNew::scatter_fwd_begin.
  ///
  ...
  /// given by IndexMapNew::scatter_fwd_ghost_positions, with
  /// IndexMapNew::scatter_fwd_ghost_positions()[i] being the index of the
  ...
  /// not be changed until after a call to IndexMapNew::scatter_rev_end.
  /// The ordering of the data is given by
  /// IndexMapNew::scatter_fwd_indices, with
  /// IndexMapNew::scatter_fwd_indices()[i] being the position in the owned
