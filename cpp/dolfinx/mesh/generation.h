...
Mesh<T> create_box(
    MPI_Comm comm, MPI_Comm subcomm, std::array<std::array<T, 3>, 2> p,
...
template <std::floating_point T = double>
Mesh<T> create_box(
    MPI_Comm comm, std::array<std::array<T, 3>, 2> p,
    std::array<std::int64_t, 3> n, CellType celltype,
...
/// @return Mesh
template <std::floating_point T = double>
Mesh<T> create_rectangle(
    MPI_Comm comm, std::array<std::array<T, 2>, 2> p,
...
/// @return A mesh.
template <std::floating_point T = double>
Mesh<T> create_interval(
    MPI_Comm comm, std::int64_t n, std::array<T, 2> p,
