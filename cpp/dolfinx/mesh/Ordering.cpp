...
//-----------------------------------------------------------------------------
void sort_1_0(mesh::AdjacencyGraph<std::int32_t>& connect_1_0,
...
//-----------------------------------------------------------------------------
void sort_2_0(mesh::AdjacencyGraph<std::int32_t>& connect_2_0,
              const mesh::MeshEntity& cell,
              const std::vector<std::int64_t>& global_vertex_indices,
              const int num_faces)
{
...
//-----------------------------------------------------------------------------
void sort_2_1(mesh::AdjacencyGraph<std::int32_t>& connect_2_1,
              const mesh::AdjacencyGraph<std::int32_t>& connect_2_0,
              const mesh::AdjacencyGraph<std::int32_t>& connect_1_0,
              const mesh::MeshEntity& cell,
              const std::vector<std::int64_t>& global_vertex_indices,
              const int num_faces)
{
...
//-----------------------------------------------------------------------------
void sort_3_0(mesh::AdjacencyGraph<std::int32_t>& connect_3_0,
              const mesh::MeshEntity& cell,
              const std::vector<std::int64_t>& global_vertex_indices)
{
...
//-----------------------------------------------------------------------------
void sort_3_1(mesh::AdjacencyGraph<std::int32_t>& connect_3_1,
              const mesh::AdjacencyGraph<std::int32_t>& connect_1_0,
              const mesh::MeshEntity& cell,
              const std::vector<std::int64_t>& global_vertex_indices)
{
...
//-----------------------------------------------------------------------------
void sort_3_2(mesh::AdjacencyGraph<std::int32_t>& connect_3_2,
              const mesh::AdjacencyGraph<std::int32_t>& connect_2_0,
              const mesh::MeshEntity& cell,
              const std::vector<std::int64_t>& global_vertex_indices)
{
    ...
    const mesh::MeshEntity& cell)
{
  ...
  // Get vertices
  std::shared_ptr<const mesh::AdjacencyGraph<std::int32_t>> connect_tdim_0
  ...
  for (int d = 1; d + 1 < tdim; ++d)
  {
    ...
    std::shared_ptr<const mesh::AdjacencyGraph<std::int32_t>> connect_d_0
        = topology.connectivity(d, 0);
    if (!connect_d_0)
      continue;

    // Get entities
    std::shared_ptr<const mesh::AdjacencyGraph<std::int32_t>> connect_tdim_d
...
void mesh::Ordering::order_simplex(mesh::Mesh& mesh)
{
  ...
  mesh::AdjacencyGraph<std::int32_t>& connect_g
  ...
  std::shared_ptr<mesh::AdjacencyGraph<std::int32_t>> connect_1_0, connect_2_0,
