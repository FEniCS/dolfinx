...
//  return set_index_map(active_layer().first, index_map, dim);
//}
////------------------------------------------------------------------------------
//std::shared_ptr<const common::IndexMap>
...
//          const StorageLayer&)>;
//  func_t read = [=](const StorageLayer& storage) {
//    return connectivity(storage, d0, d1);
//  };
//  return read_from_storage<func_t::result_type::element_type>(std::move(read));
//}
////------------------------------------------------------------------------------
...
//    throw std::runtime_error(
//        "No storage layer present. Acquire a cache lock before writing.");
//  return set_connectivity(active_layer().first, c, d0, d1);
//}
////------------------------------------------------------------------------------
//std::shared_ptr<const Eigen::Array<std::uint32_t, Eigen::Dynamic, 1>>
...
//          const StorageLayer&)>;
//  func_t read = [=](const StorageLayer& storage) {
//    return cell_permutations(storage);
//  };
//  return read_from_storage<func_t::result_type::element_type>(std::move(read));
//}
////------------------------------------------------------------------------------
...
//    throw std::runtime_error(
//        "No storage layer present. Acquire a cache lock before writing.");
//  return set_cell_permutations(active_layer().first,
//                                         cell_permutations);
//}
////------------------------------------------------------------------------------
//std::shared_ptr<
...
//  func_t read = [=](const StorageLayer& storage) {
//    return facet_permutations(storage);
//  };
//  return read_from_storage<func_t::result_type::element_type>(std::move(read));
//}
////------------------------------------------------------------------------------
...
//    throw std::runtime_error(
//        "No storage layer present. Acquire a cache lock before writing.");
//  return set_facet_permutations(active_layer().first,
//                                          facet_permutations);
//}
////------------------------------------------------------------------------------
//std::shared_ptr<const std::vector<bool>>
...
//      const StorageLayer&)>;
//  func_t read = [=](const StorageLayer& storage) {
//    return interior_facets(storage);
//  };
//  return read_from_storage<func_t::result_type::element_type>(std::move(read));
//}
////------------------------------------------------------------------------------
...
//    throw std::runtime_error(
//        "No storage layer present. Acquire a cache lock before writing.");
//  return set_interior_facets(active_layer().first, interior_facets);
//}
////------------------------------------------------------------------------------
