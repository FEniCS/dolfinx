...
//-----------------------------------------------------------------------------
void create_entities_interval(Eigen::Array<std::int32_t, Eigen::Dynamic,
                                           Eigen::Dynamic, Eigen::RowMajor>& e,
                              std::size_t dim, const std::int32_t* v)
{
  assert(dim == 0);
...
//-----------------------------------------------------------------------------
void create_entities_triangle(Eigen::Array<std::int32_t, Eigen::Dynamic,
                                           Eigen::Dynamic, Eigen::RowMajor>& e,
                              std::size_t dim, const std::int32_t* v)
{
...
//-----------------------------------------------------------------------------
void create_entities_quadrilateral(
...
//-----------------------------------------------------------------------------
void create_entities_tetrahedron(
    Eigen::Array<std::int32_t, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>&
        e,
    std::size_t dim, const std::int32_t* v)
{
...
//-----------------------------------------------------------------------------
void create_entities_hexahedron(
    Eigen::Array<std::int32_t, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>&
        e,
    std::size_t dim, const std::int32_t* v)
{
...
//-----------------------------------------------------------------------------
void mesh::create_entities(Eigen::Array<std::int32_t, Eigen::Dynamic,
                                        Eigen::Dynamic, Eigen::RowMajor>& e,
                           std::size_t dim, const std::int32_t* v,
                           mesh::CellType type)
{
  ...
  case mesh::CellType::interval:
    return create_entities_interval(e, dim, v);
  case mesh::CellType::triangle:
    return create_entities_triangle(e, dim, v);
  case mesh::CellType::tetrahedron:
    return create_entities_tetrahedron(e, dim, v);
  case mesh::CellType::quadrilateral:
    return create_entities_quadrilateral(e, dim, v);
  case mesh::CellType::hexahedron:
    return create_entities_hexahedron(e, dim, v);
  default:
