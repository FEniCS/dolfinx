      ...
      _description("missing description")
{
  ...
  {
    log::dolfin_error("Parameter.cpp", "add unset parameter", "Type unknown");
  }
}
//-----------------------------------------------------------------------------
Parameter::~Parameter()
...
//-----------------------------------------------------------------------------
std::string Parameter::key() const { return _key; }
//-----------------------------------------------------------------------------
std::string Parameter::description() const { return _description; }
//-----------------------------------------------------------------------------
bool Parameter::is_set() const { return _is_set; }
//-----------------------------------------------------------------------------
void Parameter::reset() { _is_set = false; }
//-----------------------------------------------------------------------------
std::size_t Parameter::access_count() const { return _access_count; }
//-----------------------------------------------------------------------------
std::size_t Parameter::change_count() const { return _change_count; }
//-----------------------------------------------------------------------------
void Parameter::set_range(int min_value, int max_value)
{
  if (_value.which() != 2)
  {
    log::dolfin_error("Parameter.cpp", "set range for parameter",
...
void Parameter::set_range(double min_value, double max_value)
{
  ...
  {
    log::dolfin_error(
        "Parameter.cpp", "set range for parameter",
...
void Parameter::get_range(int& min_value, int& max_value) const
{
  ...
  {
    log::dolfin_error("Parameter.cpp", "get range for parameter",
...
void Parameter::get_range(double& min_value, double& max_value) const
{
  ...
  {
    log::dolfin_error(
        "Parameter.cpp", "get range for parameter",
...
const Parameter& Parameter::operator=(int value)
{
  if (_value.which() != 2)
  {
    log::dolfin_error("Parameter.cpp", "assign parameter",
...
Parameter::operator int() const
{
  if (_value.which() != 2)
  {
    log::dolfin_error("Parameter.cpp", "convert to integer",
...
Parameter::operator std::size_t() const
{
  if (_value.which() != 2)
  {
    log::dolfin_error("Parameter.cpp", "convert to unsigned integer",
...
Parameter::operator double() const
{
  if (_value.which() != 3)
  {
    log::dolfin_error("Parameter.cpp", "convert to double",
...
Parameter::operator std::string() const
{
  if (_value.which() != 4)
  {
    log::dolfin_error("Parameter.cpp", "convert to string",
...
void Parameter::check_key(std::string key)
{
  ...
  {
    log::dolfin_error("Parameter.cpp", "check allowed name for key",
                 "Illegal character in parameter key \"%s\" (no spaces for "
                 "periods allowed)",
                 key.c_str());
  }
}
...
std::string Parameter::type_str() const
{
  ...
  log::dolfin_error("Parameter.cpp", "return parameter type string",
...
std::string Parameter::value_str() const
{
  ...
  log::dolfin_error("Parameter.cpp", "return parameter as string",
               "Cannot determine parameter type");
  return "unknown";
}
//-----------------------------------------------------------------------------
std::string Parameter::range_str() const
{
  ...
  log::dolfin_error("Parameter.cpp", "return parameter as range",
               "Cannot determine parameter type");
  return "unknown";
}
//-----------------------------------------------------------------------------
