                                       ...
                                       std::size_t gdim)
{
  ...
  default:
    // glog::error("GeometryPredicates.cpp", "is_degenerate",
...
bool GeometryPredicates::is_degenerate_2d(const std::vector<Point>& simplex)
{
  ...
  {
    // glog::info("Degenerate 2D simplex with %d vertices.", simplex.size());
    return true;
  }
...
bool GeometryPredicates::is_degenerate_3d(const std::vector<Point>& simplex)
{
  ...
  {
    // glog::info("Degenerate 3D simplex with %d vertices.", simplex.size());
    return true;
  }
    ...
    const std::vector<Point>& points, std::size_t gdim)
{
  ...
  // glog::error("GeometryPredicates.h", "call convex_hull_is_degenerate",
