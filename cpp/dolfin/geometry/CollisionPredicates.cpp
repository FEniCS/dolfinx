                                   ...
                                   const Point& point)
{
  ...
  {
    // glog::error("Cell.cpp", "intersect cell and point",
    //               "Intersection is only implemented for simplex meshes");
  ...
  // glog::error("CollisionPredicates.cpp", "compute entity-point collision",
                                   ...
                                   const mesh::MeshEntity& entity_1)
{
  ...
  // glog::error("CollisionPredicates.cpp", "compute entity-entity collision",
                                                 ...
                                                 std::size_t gdim)
{
  ...
  case 3:
    ...
    // default:
    //   glog::error("CollisionPredicates.cpp", "call collides_segment_point",
                                                   ...
                                                   std::size_t gdim)
{
  ...
  default:
    // glog::error("CollisionPredicates.cpp",
