...
def generate_functions(expressions, defaults):
    ...
    for i, expr in enumerate(expressions):
        classname = "function_%s" % hashlib.md5(repr(expr)).hexdigest()
...
import dolfin
'''
This cool hack to get past a bug in swig.
We comment out swigs import of cpp, and import the right one, i.e. dolfin.
%}
%import dolfin.i
%pythoncode %{
'''
