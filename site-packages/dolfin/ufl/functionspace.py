...
import ufl # UFL: import ufl instead
import cpp
from jit import jit
...
class FunctionSpaceBase(cpp.FunctionSpace):
    ...
    def __init__(self, mesh, element):
        ...
        if not isinstance(element, (ufl.FiniteElementBase)): # UFL: ufl.FiniteElementBase
...
class FunctionSpaceFromCpp(FunctionSpaceBase):
    ...
    def __init__(self, cppV):
        ...
        self._element = eval(cppV.element().signature(), ufl.__dict__) # UFL
...
class FunctionSpace(FunctionSpaceBase):
    ...
    def __init__(self, mesh, family, degree):
        ...
        element = ufl.FiniteElement(family, domain, degree) # UFL: ufl.FiniteElement
...
class MixedFunctionSpace(FunctionSpaceBase):
    ...
    def __init__(self, spaces):
        ...
        # Create element
        element = ufl.MixedElement([V.element() for V in spaces]) # UFL: ufl.MixedElement(*[...])
