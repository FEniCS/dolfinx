...
#FIXME: We need to confirm that this is the way we want to do it
...
def TestFunctions(V):
    ...
    return extract_basis_functions(V, ufl.TestFunctions)

def TrialFunctions(V):
    "Create trial functions from mixed function space."
    return extract_basis_functions(V, ufl.TrialFunctions)
