...
('Variable', {'header': 'dolfin/common/Variable.h', 'submodule': 'common', 'derived': ['SingularSolver', 'GenericDofMap', 'GenericSparsityPattern', 'GenericAdaptiveVariationalSolver', 'ErrorControl', 'LocalMeshData', 'Mesh', 'FunctionPlotData', 'PETScBaseMatrix', 'MeshFunction', 'MUMPSLUSolver', 'NewtonSolver', 'GenericTensor', 'Lagrange', 'BoundaryCondition', 'TimeSeries', 'PaStiXLUSolver', 'MeshValueCollection', 'TrilinosPreconditioner', 'GenericFunction', 'PETScPreconditioner', 'Quadrature', 'FunctionSpace', 'Table', 'GenericLinearSolver', 'LinearVariationalSolver', 'NonlinearVariationalSolver', 'SLEPcEigenSolver', 'MeshData'], 'bases': [], 'module': 'common'}),
...
('FunctionPlotData', {'header': 'dolfin/plot/FunctionPlotData.h', 'submodule': 'plot', 'derived': [], 'bases': ['Variable'], 'module': 'io'}),
...
('graph', {'headers': [], 'has_post': False, 'module': 'mesh', 'has_pre': False}),
('plot', {'headers': ['dolfin/plot/FunctionPlotData.h'], 'has_post': False, 'module': 'io', 'has_pre': False}),
