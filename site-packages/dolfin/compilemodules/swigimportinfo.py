...
('Variable', {'header': 'dolfin/common/Variable.h', 'submodule': 'common', 'derived': ['GenericDofMap', 'PETScVector', 'PETScLUSolver', 'TAOLinearBoundSolver', 'EpetraVector', 'Matrix', 'UnitSphere', 'VTKPlotter', 'uBLASVector', 'uBLASMatrix', 'UnitCube', 'FacetFunction', 'GenericTensor', 'FaceFunction', 'AdaptiveNonlinearVariationalSolver', 'BoundaryCondition', 'TrilinosPreconditioner', 'Scalar', 'SubMesh', 'MeshCoordinates', 'LinearVariationalSolver', 'GenericVector', 'UnitInterval', 'GenericSparsityPattern', 'UnitCircle', 'BoundaryMesh', 'AdaptiveLinearVariationalSolver', 'CholmodCholeskySolver', 'MTL4Matrix', 'CellFunction', 'LUSolver', 'SparsityPattern', 'Box', 'LinearSolver', 'EpetraKrylovSolver', 'Vector', 'MeshValueCollection', 'KrylovSolver', 'GenericLUSolver', 'PETScPreconditioner', 'Constant', 'SingularSolver', 'UnitSquare', 'MTL4Vector', 'VertexFunction', 'Rectangle', 'LocalMeshData', 'PeriodicBC', 'GenericMatrix', 'Mesh', 'MUMPSLUSolver', 'Interval', 'EpetraLUSolver', 'PETScKrylovMatrix', 'SpecialFacetFunction', 'GaussQuadrature', 'Expression', 'UnitTetrahedron', 'Lagrange', 'PETScMatrix', 'Quadrature', 'DofMap', 'GenericLinearSolver', 'SLEPcEigenSolver', 'uBLASKrylovSolver', 'SubSpace', 'GenericAdaptiveVariationalSolver', 'ErrorControl', 'EpetraMatrix', 'EdgeFunction', 'Function', 'DirichletBC', 'STLMatrix', 'PETScBaseMatrix', 'RadauQuadrature', 'MeshFunction', 'UmfpackLUSolver', 'PETScKrylovSolver', 'LobattoQuadrature', 'GaussianQuadrature', 'PaStiXLUSolver', 'ITLKrylovSolver', 'FacetArea', 'GenericFunction', 'UnitTriangle', 'NewtonSolver', 'FunctionSpace', 'TimeSeries', 'Table', 'NonlinearVariationalSolver', 'MeshData'], 'bases': [], 'module': 'common'}),
...
('PETScObject', {'header': 'dolfin/la/PETScObject.h', 'submodule': 'la', 'derived': ['PETScUserPreconditioner', 'PETScPreconditioner', 'PETScMatrix', 'PETScKrylovSolver', 'PETScVector', 'PETScLUSolver', 'PETScKrylovMatrix', 'TAOLinearBoundSolver', 'PETScBaseMatrix', 'SLEPcEigenSolver'], 'bases': [], 'module': 'la'}),
...
('LinearAlgebraFactory', {'header': 'dolfin/la/LinearAlgebraFactory.h', 'submodule': 'la', 'derived': ['EpetraFactory', 'uBLASFactory', 'PETScFactory', 'DefaultFactory', 'MTL4Factory', 'STLFactory', 'PETScCuspFactory'], 'bases': [], 'module': 'la'}),
...
('TAOLinearBoundSolver', {'header': 'dolfin/la/TAOLinearBoundSolver.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'PETScObject'], 'module': 'la'}),
...
('graph', {'headers': ['dolfin/graph/Graph.h', 'dolfin/graph/GraphBuilder.h', 'dolfin/graph/BoostGraphRenumbering.h', 'dolfin/graph/SCOTCH.h'], 'has_post': True, 'module': 'mesh', 'has_pre': False}),
