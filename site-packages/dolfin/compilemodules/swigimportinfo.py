...
('Variable', {'header': 'dolfin/common/Variable.h', 'submodule': 'common', 'derived': ['GenericDofMap', 'PETScVector', 'PETScLUSolver', 'EpetraVector', 'Matrix', 'UnitSphere', 'VTKPlotter', 'uBLASVector', 'uBLASMatrix', 'GenericLinearOperator', 'UnitCube', 'FacetFunction', 'GenericTensor', 'FaceFunction', 'AdaptiveNonlinearVariationalSolver', 'BoundaryCondition', 'TrilinosPreconditioner', 'Scalar', 'LinearOperator', 'EpetraKrylovSolver', 'MeshFunction', 'SubMesh', 'LinearAlgebraObject', 'UnitInterval', 'GenericSparsityPattern', 'UnitCircle', 'BoundaryMesh', 'AdaptiveLinearVariationalSolver', 'CholmodCholeskySolver', 'CellFunction', 'LUSolver', 'SparsityPattern', 'Box', 'LinearSolver', 'PETScLinearOperator', 'MeshCoordinates', 'Vector', 'MeshValueCollection', 'KrylovSolver', 'GenericLUSolver', 'PETScPreconditioner', 'SingularSolver', 'UnitSquare', 'MTL4Vector', 'GenericVector', 'VertexFunction', 'Rectangle', 'LocalMeshData', 'PeriodicBC', 'GenericMatrix', 'Mesh', 'MUMPSLUSolver', 'Interval', 'EpetraLUSolver', 'SpecialFacetFunction', 'Constant', 'Expression', 'UnitTetrahedron', 'Lagrange', 'PETScMatrix', 'MTL4Matrix', 'DofMap', 'GenericLinearSolver', 'SLEPcEigenSolver', 'uBLASKrylovSolver', 'SubSpace', 'GenericAdaptiveVariationalSolver', 'ErrorControl', 'EpetraMatrix', 'EdgeFunction', 'Function', 'DirichletBC', 'STLMatrix', 'PETScBaseMatrix', 'LinearVariationalSolver', 'UmfpackLUSolver', 'PETScKrylovSolver', 'TimeSeries', 'PaStiXLUSolver', 'ITLKrylovSolver', 'FacetArea', 'GenericFunction', 'UnitTriangle', 'uBLASLinearOperator', 'NewtonSolver', 'FunctionSpace', 'Table', 'NonlinearVariationalSolver', 'MeshData'], 'bases': [], 'module': 'common'}),
...
('LinearAlgebraObject', {'header': 'dolfin/la/LinearAlgebraObject.h', 'submodule': 'la', 'derived': ['GenericVector', 'Matrix', 'GenericMatrix', 'GenericTensor', 'Scalar', 'uBLASMatrix', 'PETScMatrix', 'PETScVector', 'MTL4Vector', 'STLMatrix', 'MTL4Matrix', 'Vector', 'LinearOperator', 'uBLASVector', 'uBLASLinearOperator', 'EpetraMatrix', 'GenericLinearOperator', 'EpetraVector', 'PETScLinearOperator'], 'bases': ['Variable'], 'module': 'la'}),
('GenericTensor', {'header': 'dolfin/la/GenericTensor.h', 'submodule': 'la', 'derived': ['GenericVector', 'Matrix', 'GenericMatrix', 'uBLASVector', 'Scalar', 'uBLASMatrix', 'PETScMatrix', 'PETScVector', 'MTL4Vector', 'STLMatrix', 'MTL4Matrix', 'Vector', 'EpetraMatrix', 'EpetraVector'], 'bases': ['Variable', 'LinearAlgebraObject'], 'module': 'la'}),
('GenericMatrix', {'header': 'dolfin/la/GenericMatrix.h', 'submodule': 'la', 'derived': ['Matrix', 'uBLASMatrix', 'PETScMatrix', 'STLMatrix', 'MTL4Matrix', 'EpetraMatrix'], 'bases': ['Variable', 'GenericTensor', 'LinearAlgebraObject', 'GenericLinearOperator'], 'module': 'la'}),
...
('GenericVector', {'header': 'dolfin/la/GenericVector.h', 'submodule': 'la', 'derived': ['MTL4Vector', 'uBLASVector', 'Vector', 'EpetraVector', 'PETScVector'], 'bases': ['Variable', 'GenericTensor', 'LinearAlgebraObject'], 'module': 'la'}),
...
('GenericLinearOperator', {'header': 'dolfin/la/GenericLinearOperator.h', 'submodule': 'la', 'derived': ['Matrix', 'GenericMatrix', 'uBLASMatrix', 'PETScMatrix', 'uBLASLinearOperator', 'STLMatrix', 'MTL4Matrix', 'LinearOperator', 'EpetraMatrix', 'PETScLinearOperator'], 'bases': ['Variable', 'LinearAlgebraObject'], 'module': 'la'}),
...
('MTL4Matrix', {'header': 'dolfin/la/MTL4Matrix.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'GenericMatrix', 'LinearAlgebraObject', 'GenericLinearOperator', 'GenericTensor'], 'module': 'la'}),
...
('MTL4Vector', {'header': 'dolfin/la/MTL4Vector.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'GenericTensor', 'GenericVector', 'LinearAlgebraObject'], 'module': 'la'}),
