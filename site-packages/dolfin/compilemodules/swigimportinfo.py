...
('Variable', {'header': 'dolfin/common/Variable.h', 'submodule': 'common', 'derived': ['GenericDofMap', 'PETScVector', 'PETScLUSolver', 'EpetraVector', 'Matrix', 'UnitSphere', 'VTKPlotter', 'uBLASVector', 'uBLASMatrix', 'UnitCube', 'FacetFunction', 'GenericTensor', 'FaceFunction', 'AdaptiveNonlinearVariationalSolver', 'BoundaryCondition', 'TrilinosPreconditioner', 'Scalar', 'SparsityPattern', 'MeshCoordinates', 'LinearVariationalSolver', 'GenericVector', 'UnitInterval', 'GenericSparsityPattern', 'UnitCircle', 'BoundaryMesh', 'AdaptiveLinearVariationalSolver', 'CholmodCholeskySolver', 'MTL4Matrix', 'CellFunction', 'LUSolver', 'SubMesh', 'Box', 'LinearSolver', 'EpetraKrylovSolver', 'Vector', 'MeshValueCollection', 'KrylovSolver', 'GenericLUSolver', 'PETScPreconditioner', 'Constant', 'SingularSolver', 'UnitSquare', 'MTL4Vector', 'VertexFunction', 'Rectangle', 'LocalMeshData', 'PeriodicBC', 'GenericMatrix', 'Mesh', 'MUMPSLUSolver', 'Interval', 'EpetraLUSolver', 'PETScLinearOperator', 'SpecialFacetFunction', 'GaussQuadrature', 'Expression', 'UnitTetrahedron', 'Lagrange', 'PETScMatrix', 'Quadrature', 'DofMap', 'GenericLinearSolver', 'SLEPcEigenSolver', 'uBLASKrylovSolver', 'SubSpace', 'GenericAdaptiveVariationalSolver', 'ErrorControl', 'EpetraMatrix', 'EdgeFunction', 'Function', 'DirichletBC', 'STLMatrix', 'PETScBaseMatrix', 'RadauQuadrature', 'MeshFunction', 'UmfpackLUSolver', 'PETScKrylovSolver', 'LobattoQuadrature', 'GaussianQuadrature', 'PaStiXLUSolver', 'ITLKrylovSolver', 'FacetArea', 'GenericFunction', 'UnitTriangle', 'NewtonSolver', 'FunctionSpace', 'TimeSeries', 'Table', 'NonlinearVariationalSolver', 'MeshData'], 'bases': [], 'module': 'common'}),
...
('PETScObject', {'header': 'dolfin/la/PETScObject.h', 'submodule': 'la', 'derived': ['PETScUserPreconditioner', 'PETScPreconditioner', 'PETScMatrix', 'PETScKrylovSolver', 'PETScVector', 'PETScLUSolver', 'PETScLinearOperator', 'PETScBaseMatrix', 'SLEPcEigenSolver'], 'bases': [], 'module': 'la'}),
('PETScBaseMatrix', {'header': 'dolfin/la/PETScBaseMatrix.h', 'submodule': 'la', 'derived': ['PETScLinearOperator', 'PETScMatrix'], 'bases': ['Variable', 'PETScObject'], 'module': 'la'}),
...
('uBLASLinearOperator', {'header': 'dolfin/la/uBLASLinearOperator.h', 'submodule': 'la', 'derived': [], 'bases': [], 'module': 'la'}),
...
('PETScLinearOperator', {'header': 'dolfin/la/PETScLinearOperator.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'PETScBaseMatrix', 'PETScObject'], 'module': 'la'}),
