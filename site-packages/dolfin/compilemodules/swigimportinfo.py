...
('Variable', {'header': 'dolfin/common/Variable.h', 'submodule': 'common', 'derived': ['SingularSolver', 'GenericDofMap', 'GenericSparsityPattern', 'GenericAdaptiveVariationalSolver', 'ErrorControl', 'LocalMeshData', 'Mesh', 'PETScBaseMatrix', 'MeshFunction', 'MUMPSLUSolver', 'NewtonSolver', 'GenericTensor', 'Lagrange', 'BoundaryCondition', 'TimeSeries', 'PaStiXLUSolver', 'MeshValueCollection', 'TrilinosPreconditioner', 'GenericFunction', 'PETScPreconditioner', 'VTKPlotter', 'Quadrature', 'FunctionSpace', 'Table', 'GenericLinearSolver', 'LinearVariationalSolver', 'NonlinearVariationalSolver', 'SLEPcEigenSolver', 'MeshData'], 'bases': [], 'module': 'common'}),
('Hierarchical', {'header': 'dolfin/common/Hierarchical.h', 'submodule': 'common', 'derived': ['Function', 'Form', 'LinearVariationalProblem', 'Mesh', 'ErrorControl', 'FunctionSpace', 'NonlinearVariationalProblem', 'DirichletBC', 'MeshFunction'], 'bases': [], 'module': 'common'}),
...
('GenericTensor', {'header': 'dolfin/la/GenericTensor.h', 'submodule': 'la', 'derived': ['GenericVector', 'Matrix', 'GenericMatrix', 'uBLASVector', 'Scalar', 'uBLASMatrix', 'PETScMatrix', 'PETScVector', 'MTL4Vector', 'STLMatrix', 'MTL4Matrix', 'Vector', 'EpetraMatrix', 'EpetraVector'], 'bases': ['Variable'], 'module': 'la'}),
('GenericMatrix', {'header': 'dolfin/la/GenericMatrix.h', 'submodule': 'la', 'derived': ['Matrix', 'uBLASMatrix', 'PETScMatrix', 'STLMatrix', 'MTL4Matrix', 'EpetraMatrix'], 'bases': ['Variable', 'GenericTensor'], 'module': 'la'}),
...
('GenericVector', {'header': 'dolfin/la/GenericVector.h', 'submodule': 'la', 'derived': ['MTL4Vector', 'uBLASVector', 'Vector', 'EpetraVector', 'PETScVector'], 'bases': ['Variable', 'GenericTensor'], 'module': 'la'}),
('GenericLinearSolver', {'header': 'dolfin/la/GenericLinearSolver.h', 'submodule': 'la', 'derived': ['GenericLUSolver', 'LinearSolver', 'UmfpackLUSolver', 'CholmodCholeskySolver', 'EpetraLUSolver', 'PETScKrylovSolver', 'PETScLUSolver', 'LUSolver', 'EpetraKrylovSolver', 'uBLASKrylovSolver', 'ITLKrylovSolver', 'KrylovSolver'], 'bases': ['Variable'], 'module': 'la'}),
...
('PETScObject', {'header': 'dolfin/la/PETScObject.h', 'submodule': 'la', 'derived': ['PETScUserPreconditioner', 'PETScPreconditioner', 'PETScKrylovSolver', 'PETScVector', 'PETScLUSolver', 'PETScBaseMatrix', 'SLEPcEigenSolver'], 'bases': [], 'module': 'la'}),
('PETScBaseMatrix', {'header': 'dolfin/la/PETScBaseMatrix.h', 'submodule': 'la', 'derived': ['PETScKrylovMatrix', 'PETScMatrix'], 'bases': ['Variable', 'PETScObject'], 'module': 'la'}),
('PETScMatrixDeleter', {'header': 'dolfin/la/PETScBaseMatrix.h', 'submodule': 'la', 'derived': [], 'bases': [], 'module': 'la'}),
('uBLASFactory', {'header': 'dolfin/la/uBLASFactory.h', 'submodule': 'la', 'derived': [], 'bases': ['LinearAlgebraFactory'], 'module': 'la'}),
('tuple', {'header': 'dolfin/la/uBLASMatrix.h', 'submodule': 'la', 'derived': [], 'bases': [], 'module': 'la'}),
('uBLASMatrix', {'header': 'dolfin/la/uBLASMatrix.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'GenericMatrix', 'GenericTensor'], 'module': 'la'}),
('uBLASKrylovMatrix', {'header': 'dolfin/la/uBLASKrylovMatrix.h', 'submodule': 'la', 'derived': [], 'bases': [], 'module': 'la'}),
('PETScMatrix', {'header': 'dolfin/la/PETScMatrix.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'GenericMatrix', 'PETScBaseMatrix', 'PETScObject', 'GenericTensor'], 'module': 'la'}),
('PETScKrylovMatrix', {'header': 'dolfin/la/PETScKrylovMatrix.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'PETScBaseMatrix', 'PETScObject'], 'module': 'la'}),
...
('EpetraMatrix', {'header': 'dolfin/la/EpetraMatrix.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'GenericMatrix', 'GenericTensor'], 'module': 'la'}),
('EpetraVector', {'header': 'dolfin/la/EpetraVector.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'GenericTensor', 'GenericVector'], 'module': 'la'}),
...
('ITLKrylovSolver', {'header': 'dolfin/la/ITLKrylovSolver.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'GenericLinearSolver'], 'module': 'la'}),
...
('MTL4Matrix', {'header': 'dolfin/la/MTL4Matrix.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'GenericMatrix', 'GenericTensor'], 'module': 'la'}),
('STLMatrix', {'header': 'dolfin/la/STLMatrix.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'GenericMatrix', 'GenericTensor'], 'module': 'la'}),
('CoordinateMatrix', {'header': 'dolfin/la/CoordinateMatrix.h', 'submodule': 'la', 'derived': [], 'bases': [], 'module': 'la'}),
('uBLASVector', {'header': 'dolfin/la/uBLASVector.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'GenericTensor', 'GenericVector'], 'module': 'la'}),
('PETScVector', {'header': 'dolfin/la/PETScVector.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'GenericTensor', 'GenericVector', 'PETScObject'], 'module': 'la'}),
('PETScVectorDeleter', {'header': 'dolfin/la/PETScVector.h', 'submodule': 'la', 'derived': [], 'bases': [], 'module': 'la'}),
('MTL4Vector', {'header': 'dolfin/la/MTL4Vector.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'GenericTensor', 'GenericVector'], 'module': 'la'}),
('SparsityPattern', {'header': 'dolfin/la/SparsityPattern.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'GenericSparsityPattern'], 'module': 'la'}),
('LinearAlgebraFactory', {'header': 'dolfin/la/LinearAlgebraFactory.h', 'submodule': 'la', 'derived': ['EpetraFactory', 'uBLASFactory', 'PETScFactory', 'STLFactory', 'MTL4Factory', 'DefaultFactory', 'PETScCuspFactory'], 'bases': [], 'module': 'la'}),
('DefaultFactory', {'header': 'dolfin/la/DefaultFactory.h', 'submodule': 'la', 'derived': [], 'bases': ['LinearAlgebraFactory'], 'module': 'la'}),
('PETScUserPreconditioner', {'header': 'dolfin/la/PETScUserPreconditioner.h', 'submodule': 'la', 'derived': [], 'bases': ['PETScObject'], 'module': 'la'}),
('PETScFactory', {'header': 'dolfin/la/PETScFactory.h', 'submodule': 'la', 'derived': [], 'bases': ['LinearAlgebraFactory'], 'module': 'la'}),
('PETScCuspFactory', {'header': 'dolfin/la/PETScCuspFactory.h', 'submodule': 'la', 'derived': [], 'bases': ['LinearAlgebraFactory'], 'module': 'la'}),
('EpetraFactory', {'header': 'dolfin/la/EpetraFactory.h', 'submodule': 'la', 'derived': [], 'bases': ['LinearAlgebraFactory'], 'module': 'la'}),
('MTL4Factory', {'header': 'dolfin/la/MTL4Factory.h', 'submodule': 'la', 'derived': [], 'bases': ['LinearAlgebraFactory'], 'module': 'la'}),
('STLFactory', {'header': 'dolfin/la/STLFactory.h', 'submodule': 'la', 'derived': [], 'bases': ['LinearAlgebraFactory'], 'module': 'la'}),
...
('Vector', {'header': 'dolfin/la/Vector.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'GenericTensor', 'GenericVector'], 'module': 'la'}),
('Matrix', {'header': 'dolfin/la/Matrix.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'GenericMatrix', 'GenericTensor'], 'module': 'la'}),
('Scalar', {'header': 'dolfin/la/Scalar.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable', 'GenericTensor'], 'module': 'la'}),
...
('SingularSolver', {'header': 'dolfin/la/SingularSolver.h', 'submodule': 'la', 'derived': [], 'bases': ['Variable'], 'module': 'la'}),
...
('ParallelData', {'header': 'dolfin/mesh/ParallelData.h', 'submodule': 'mesh', 'derived': [], 'bases': [], 'module': 'mesh'}),
...
('MeshEntity', {'header': 'dolfin/mesh/MeshEntity.h', 'submodule': 'mesh', 'derived': ['Facet', 'Cell', 'Edge', 'Vertex', 'Face'], 'bases': [], 'module': 'mesh'}),
...
('Interval', {'header': 'dolfin/mesh/Interval.h', 'submodule': 'mesh', 'derived': [], 'bases': ['Variable', 'Mesh', 'Hierarchical'], 'module': 'mesh'}),
...
('BoostGraphRenumbering', {'header': 'dolfin/graph/BoostGraphRenumbering.h', 'submodule': 'graph', 'derived': [], 'bases': [], 'module': 'mesh'}),
('ALE', {'header': 'dolfin/ale/ALE.h', 'submodule': 'ale', 'derived': [], 'bases': [], 'module': 'mesh'}),
('GenericFunction', {'header': 'dolfin/function/GenericFunction.h', 'submodule': 'function', 'derived': ['Function', 'Constant', 'SpecialFacetFunction', 'MeshCoordinates', 'Expression', 'FacetArea'], 'bases': ['Variable'], 'module': 'function'}),
('Expression', {'header': 'dolfin/function/Expression.h', 'submodule': 'function', 'derived': ['FacetArea', 'Constant', 'SpecialFacetFunction', 'MeshCoordinates'], 'bases': ['Variable', 'GenericFunction'], 'module': 'function'}),
('Function', {'header': 'dolfin/function/Function.h', 'submodule': 'function', 'derived': [], 'bases': ['Variable', 'Hierarchical', 'GenericFunction'], 'module': 'function'}),
...
('Constant', {'header': 'dolfin/function/Constant.h', 'submodule': 'function', 'derived': [], 'bases': ['Variable', 'GenericFunction', 'Expression'], 'module': 'function'}),
('FacetArea', {'header': 'dolfin/function/SpecialFunctions.h', 'submodule': 'function', 'derived': [], 'bases': ['Variable', 'GenericFunction', 'Expression'], 'module': 'function'}),
('MeshCoordinates', {'header': 'dolfin/function/SpecialFunctions.h', 'submodule': 'function', 'derived': [], 'bases': ['Variable', 'GenericFunction', 'Expression'], 'module': 'function'}),
('SpecialFacetFunction', {'header': 'dolfin/function/SpecialFacetFunction.h', 'submodule': 'function', 'derived': [], 'bases': ['Variable', 'GenericFunction', 'Expression'], 'module': 'function'}),
...
('Quadrature', {'header': 'dolfin/quadrature/Quadrature.h', 'submodule': 'quadrature', 'derived': ['GaussQuadrature', 'RadauQuadrature', 'LobattoQuadrature', 'GaussianQuadrature'], 'bases': ['Variable'], 'module': 'fem'}),
('GaussianQuadrature', {'header': 'dolfin/quadrature/GaussianQuadrature.h', 'submodule': 'quadrature', 'derived': ['GaussQuadrature', 'RadauQuadrature', 'LobattoQuadrature'], 'bases': ['Variable', 'Quadrature'], 'module': 'fem'}),
('GaussQuadrature', {'header': 'dolfin/quadrature/GaussQuadrature.h', 'submodule': 'quadrature', 'derived': [], 'bases': ['Variable', 'Quadrature', 'GaussianQuadrature'], 'module': 'fem'}),
('RadauQuadrature', {'header': 'dolfin/quadrature/RadauQuadrature.h', 'submodule': 'quadrature', 'derived': [], 'bases': ['Variable', 'Quadrature', 'GaussianQuadrature'], 'module': 'fem'}),
('LobattoQuadrature', {'header': 'dolfin/quadrature/LobattoQuadrature.h', 'submodule': 'quadrature', 'derived': [], 'bases': ['Variable', 'Quadrature', 'GaussianQuadrature'], 'module': 'fem'}),
...
('BasisFunction', {'header': 'dolfin/fem/BasisFunction.h', 'submodule': 'fem', 'derived': [], 'bases': [], 'module': 'fem'}),
...
('Assembler', {'header': 'dolfin/fem/Assembler.h', 'submodule': 'fem', 'derived': [], 'bases': [], 'module': 'fem'}),
('SparsityPatternBuilder', {'header': 'dolfin/fem/SparsityPatternBuilder.h', 'submodule': 'fem', 'derived': [], 'bases': [], 'module': 'fem'}),
('SymmetricAssembler', {'header': 'dolfin/fem/SymmetricAssembler.h', 'submodule': 'fem', 'derived': [], 'bases': [], 'module': 'fem'}),
('SystemAssembler', {'header': 'dolfin/fem/SystemAssembler.h', 'submodule': 'fem', 'derived': [], 'bases': [], 'module': 'fem'}),
...
('OpenMpAssembler', {'header': 'dolfin/fem/OpenMpAssembler.h', 'submodule': 'fem', 'derived': [], 'bases': [], 'module': 'fem'}),
...
('la', {'headers': ['dolfin/la/ublas.h', 'dolfin/la/GenericTensor.h', 'dolfin/la/GenericMatrix.h', 'dolfin/la/GenericSparsityPattern.h', 'dolfin/la/GenericVector.h', 'dolfin/la/GenericLinearSolver.h', 'dolfin/la/GenericLUSolver.h', 'dolfin/la/PETScObject.h', 'dolfin/la/PETScBaseMatrix.h', 'dolfin/la/uBLASFactory.h', 'dolfin/la/uBLASMatrix.h', 'dolfin/la/uBLASKrylovMatrix.h', 'dolfin/la/PETScMatrix.h', 'dolfin/la/PETScKrylovMatrix.h', 'dolfin/la/PETScPreconditioner.h', 'dolfin/la/EpetraLUSolver.h', 'dolfin/la/EpetraKrylovSolver.h', 'dolfin/la/EpetraMatrix.h', 'dolfin/la/EpetraVector.h', 'dolfin/la/PETScKrylovSolver.h', 'dolfin/la/PETScLUSolver.h', 'dolfin/la/CholmodCholeskySolver.h', 'dolfin/la/UmfpackLUSolver.h', 'dolfin/la/ITLKrylovSolver.h', 'dolfin/la/MUMPSLUSolver.h', 'dolfin/la/PaStiXLUSolver.h', 'dolfin/la/MTL4Matrix.h', 'dolfin/la/STLMatrix.h', 'dolfin/la/CoordinateMatrix.h', 'dolfin/la/uBLASVector.h', 'dolfin/la/PETScVector.h', 'dolfin/la/MTL4Vector.h', 'dolfin/la/SparsityPattern.h', 'dolfin/la/LinearAlgebraFactory.h', 'dolfin/la/DefaultFactory.h', 'dolfin/la/PETScUserPreconditioner.h', 'dolfin/la/PETScFactory.h', 'dolfin/la/PETScCuspFactory.h', 'dolfin/la/EpetraFactory.h', 'dolfin/la/MTL4Factory.h', 'dolfin/la/STLFactory.h', 'dolfin/la/SLEPcEigenSolver.h', 'dolfin/la/TrilinosPreconditioner.h', 'dolfin/la/uBLASSparseMatrix.h', 'dolfin/la/uBLASDenseMatrix.h', 'dolfin/la/uBLASPreconditioner.h', 'dolfin/la/uBLASKrylovSolver.h', 'dolfin/la/uBLASILUPreconditioner.h', 'dolfin/la/Vector.h', 'dolfin/la/Matrix.h', 'dolfin/la/Scalar.h', 'dolfin/la/LinearSolver.h', 'dolfin/la/KrylovSolver.h', 'dolfin/la/LUSolver.h', 'dolfin/la/SingularSolver.h', 'dolfin/la/solve.h', 'dolfin/la/BlockVector.h', 'dolfin/la/BlockMatrix.h'], 'has_post': True, 'module': 'la', 'has_pre': True}),
('nls', {'headers': ['dolfin/nls/NonlinearProblem.h', 'dolfin/nls/NewtonSolver.h'], 'has_post': False, 'module': 'la', 'has_pre': True}),
...
('mesh', {'headers': ['dolfin/mesh/CellType.h', 'dolfin/mesh/MeshTopology.h', 'dolfin/mesh/MeshGeometry.h', 'dolfin/mesh/MeshDomains.h', 'dolfin/mesh/MeshData.h', 'dolfin/mesh/ParallelData.h', 'dolfin/mesh/Mesh.h', 'dolfin/mesh/MeshEntity.h', 'dolfin/mesh/MeshEntityIterator.h', 'dolfin/mesh/MeshEntityIteratorBase.h', 'dolfin/mesh/SubsetIterator.h', 'dolfin/mesh/Point.h', 'dolfin/mesh/Vertex.h', 'dolfin/mesh/Edge.h', 'dolfin/mesh/Face.h', 'dolfin/mesh/Facet.h', 'dolfin/mesh/Cell.h', 'dolfin/mesh/FacetCell.h', 'dolfin/mesh/MeshConnectivity.h', 'dolfin/mesh/MeshEditor.h', 'dolfin/mesh/DynamicMeshEditor.h', 'dolfin/mesh/LocalMeshValueCollection.h', 'dolfin/mesh/MeshFunction.h', 'dolfin/mesh/MeshPartitioning.h', 'dolfin/mesh/MeshValueCollection.h', 'dolfin/mesh/MeshColoring.h', 'dolfin/mesh/MeshRenumbering.h', 'dolfin/mesh/MeshTransformation.h', 'dolfin/mesh/LocalMeshData.h', 'dolfin/mesh/SubDomain.h', 'dolfin/mesh/SubMesh.h', 'dolfin/mesh/DomainBoundary.h', 'dolfin/mesh/BoundaryMesh.h', 'dolfin/mesh/Interval.h'], 'has_post': True, 'module': 'mesh', 'has_pre': True}),
('generation', {'headers': ['dolfin/generation/PolygonalMeshGenerator.h', 'dolfin/generation/PolyhedralMeshGenerator.h', 'dolfin/generation/Triangulate.h', 'dolfin/generation/UnitTetrahedron.h', 'dolfin/generation/UnitCube.h', 'dolfin/generation/UnitInterval.h', 'dolfin/generation/UnitTriangle.h', 'dolfin/generation/UnitSquare.h', 'dolfin/generation/UnitCircle.h', 'dolfin/generation/Box.h', 'dolfin/generation/Rectangle.h', 'dolfin/generation/UnitSphere.h'], 'has_post': False, 'module': 'mesh', 'has_pre': False}),
...
('graph', {'headers': ['dolfin/graph/Graph.h', 'dolfin/graph/GraphBuilder.h', 'dolfin/graph/BoostGraphRenumbering.h'], 'has_post': True, 'module': 'mesh', 'has_pre': False}),
