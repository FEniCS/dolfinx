...
('Hierarchical', {'header': 'dolfin/common/Hierarchical.h', 'submodule': 'common', 'derived': ['UnitInterval', 'UnitCubeMesh', 'UnitCircle', 'BoundaryMesh', 'SubSpace', 'LinearVariationalProblem', 'GoalFunctional', 'ErrorControl', 'VertexFunction', 'UnitCircleMesh', 'DirichletBC', 'UnitSquare', 'Function', 'Form', 'UnitIntervalMesh', 'UnitTriangleMesh', 'CellFunction', 'UnitCube', 'Mesh', 'BoxMesh', 'EdgeFunction', 'IntervalMesh', 'SubMesh', 'MeshFunction', 'FaceFunction', 'FunctionSpace', 'FacetFunction', 'UnitTetrahedronMesh', 'Interval', 'UnitSquareMesh', 'NonlinearVariationalProblem', 'UnitTriangle', 'UnitTetrahedron', 'RectangleMesh'], 'bases': [], 'module': 'common'}),
...
('Mesh', {'header': 'dolfin/mesh/Mesh.h', 'submodule': 'mesh', 'derived': ['Interval', 'UnitTriangle', 'UnitCubeMesh', 'UnitCircle', 'UnitTetrahedron', 'UnitTetrahedronMesh', 'BoxMesh', 'UnitTriangleMesh', 'UnitInterval', 'UnitCube', 'UnitSquareMesh', 'BoundaryMesh', 'RectangleMesh', 'UnitCircleMesh', 'IntervalMesh', 'UnitIntervalMesh', 'SubMesh', 'UnitSquare'], 'bases': ['Variable', 'Hierarchical'], 'module': 'mesh'}),
