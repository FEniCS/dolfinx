...
__date__ = "2009-08-15 -- 2009-12-11"
...
_pydolfin_shared_ptr_classes = ["GenericFunction","Expression","Function",
                                "SubDomain","Mesh","DofMap","FiniteElement",
                                "FunctionSpace"]
...
def compile_extension_module(code, module_name="",
    ...
    shared_ptr_declarations = extract_shared_ptr_declaration(code, _pydolfin_shared_ptr_classes, using_reduced_import)
...
def extract_shared_ptr_declaration(code, shared_ptr_classes, using_reduced_import=True):
