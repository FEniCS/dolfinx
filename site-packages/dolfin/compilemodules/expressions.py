...
def expression_to_dolfin_expression(expr, generic_function_members):
    ...
    generic_function_member_names = [name for name, shape in generic_function_members]
    ...
    # TODO: Support MeshFunction<typename>(mesh, tdim)
    #meshfunction_members = []
    #for name, typename in meshfunction_members:
