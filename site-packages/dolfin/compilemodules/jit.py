...
def jit(form, form_compiler_parameters=None, mpi_comm=None):
    ...
    # Check DOLFIN build time UFC matches currently loaded UFC from
    # which form (element) signatures are computed
    # FIXME: jitobject.ufc_signature is not in form compiler specification.
    #        Rename to something meaningful.
    if cpp.__ufcsignature__ != form_compiler.jitobject.ufc_signature:
        cpp.dolfin_error("jit.py",
                         "perform just-in-time compilation of form",
