...
__date__ = "2008-12-08 -- 2009-10-06"
__copyright__ = "Copyright (C) 2008-2009 Anders Logg"
__license__  = "GNU LGPL Version 2.1"

# Modified by Johan Hake, 2008-2009

__all__ = ["MeshCoordinates", "CellSize", "FacetArea", "FacetNormal"]
...
class MeshCoordinates(Expression, ufl.Function, cpp.MeshCoordinates):
...
class CellSize(Expression, ufl.Function, cpp.CellSize):
    def __init__(self, mesh):
        ...
        ufl.Function.__init__(self, self._ufl_element)
        cpp.CellSize.__init__(self, mesh)

CellSize.__doc__ = cpp.CellSize.__doc__

class FacetArea(Expression, ufl.Function, cpp.FacetArea):
...
# Simple definition of FacetNormal without needing to refer to UFL cells
