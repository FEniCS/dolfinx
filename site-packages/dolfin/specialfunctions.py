...
__all__ = ["MeshCoordinates", "FacetNormal", "MeshSize", "AvgMeshSize", 
           "FacetArea", "InvFacetArea","IsOutflowFacet", "SUPGStabilizer"]
...
class IsOutflowFacet(ffc.Function, cpp.IsOutflowFacet, Function):
    def __init__(self, field):
        ...
        assert isinstance(field,ffc.Function), "Provide a ffc.Function for 'field'"
...
class SUPGStabilizer(ffc.Function, cpp.SUPGStabilizer, Function):
    def __init__(self, field, sigma=1.0):
        ...
        calculated from the local Péclet number, a the advective field.
