...
SpecialFunctions.h) like MeshSize."""
...
__all__ = ["MeshCoordinates", "CellSize", "FacetArea", "SUPGStabilizer"]
...
class MeshCoordinates(Function, ufl.Function, cpp.MeshCoordinates):
...
class CellSize(Function, ufl.Function, cpp.CellSize):
    def __init__(self, mesh):
...
class FacetArea(Function, ufl.Function, cpp.FacetArea):
...
class SUPGStabilizer(Function, ufl.Function, cpp.SUPGStabilizer):
