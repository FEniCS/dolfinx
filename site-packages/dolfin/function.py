...
__date__ = "2009-10-06 -- 2009-11-04"
    ...
    def __init__(self, *args):
        ...
        if isinstance(args[0], Function):
            ...
            if len(args) == 1:
                ...
                ufl.Function.__init__(self, other._element)
                return
            ...
            # If using sub-function constructor
                ...
                ufl.Function.__init__(self, self.function_space().ufl_element())
                return
            else:
        ...
        ufl.Function.__init__(self, V.ufl_element())
