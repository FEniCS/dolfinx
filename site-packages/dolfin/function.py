...
class FunctionMetaClass(type):
    def __new__(cls, name, bases, dict_):
        ...
        if 'cpparg' in dict_  and ('eval' or 'eval_data') in dict_:
        ...
        if 'eval' in dict_:
            ...
            return Function_factory(name, cpp.Function, dict_["eval"], None, user_init)

        # If the Function class is a user defined python class, case 5. from docstring
        if 'eval_data' in dict_:
            user_init = dict_.get("__init__", None)
            return Function_factory(name, cpp.Function, None, dict_["eval_data"], user_init)
