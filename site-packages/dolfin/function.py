...
__date__ = "2009-10-06 -- 2009-10-06"
...
class Function(ufl.Function, cpp.Function):
    ...
    def __init__(self, *args):
        ...
        if isinstance(args[0], Function):
            if len(args[0]) != 1:
                raise TypeError, "expected one and only one argument when copying a 'Function'"
            other = args[0]
    ...
    def _sub(self, i, deepcopy = False):
        ...
        if deepcopy:
            return Function(self._V.spaces[i], sub_function)
        else:
            return_func = Function(self._V.spaces[i])
            return_func.assign(sub_function)
            return return_func
