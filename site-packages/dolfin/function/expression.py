...
class Expression(object):
    ...
    above for JIT-compiled expressions: 'cppcode' and 'defaults'.

    >>> class MyExpression0(Expression):
            cppcode = 'A*exp(-(pow(x[0]-0.5,2) + pow(x[1]-0.5,2))/B)'
    ...
    def __new__(cls, cppcode=None, defaults=None, element=None, cell=None, degree=None):
    ...
    def __init__(self, cppcode=None, defaults=None, element=None, cell=None, degree=None): pass
