...
def assemble_system(A_form,
    ...
    cpp.assemble(A_tensor, A_dolfin_form, cell_domains, exterior_facet_domains, interior_facet_domains, reset_tensor)
    cpp.assemble(b_tensor, b_dolfin_form, cell_domains, exterior_facet_domains, interior_facet_domains, reset_tensor)
