...
import cpp
from cpp import info, warning, error, debug
...
class Expression(object):
    ...
    def __new__(cls, cpparg = None, defaults = None, V = None, element = None):
        ...
        debug("Trying to automatically figure out the element")
        debug("Assuming it's a triangle")
        domain = "triangle"
        import numpy
        ...
        debug("Automatic selection of element: " + str(element))
        ...
        # FIXME: Strange! Why extract the element when it is not used???
