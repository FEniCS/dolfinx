...
def create_expression_class(name,
    ...
    def __init__(self, *args, **kwargs):
        ...
        if element is None and len(args) > 0:
            element = _auto_select_element(args[0])
...
def _auto_select_element(cpparg, degree=None):
    ...
    if len(shape) == 0:
        ...
        element = ufl.FiniteElement("Quadrature", None, None)
    elif len(shape) == 1:
        cpp.debug("It's a vector!")
        element = ufl.VectorElement("Quadrature", None, None, shape[0])
    else:
        cpp.debug("It's a tensor!")
        element = ufl.TensorElement("Quadrature", None, None, shape)
