...
def create_expression_class(name,
    ...
    cpp.debug("Calling function create_expression_class with name = " + str(name))
    ...
    def __init__(self, *args, **kwargs):
        ...
        print "Entering __init__ function with kwargs =", str(kwargs)
...
class Expression(object):
    ...
    def __new__(cls, cpparg = None, defaults = None, V = None, element = None):
        ...
        cpp.debug("Entering __new__ function in Expression class")
...
def _is_complex_expression(cpparg):
    ...
    return isinstance(cpparg, str) and "class" in cpparg and "Expression" in cpparg
        ...
        #cpp.debug("Trying to automatically figure out the element")
        #cpp.debug("Assuming it's a triangle")
        #domain = "triangle"
        #import numpy
        #shape = numpy.shape(cpparg)
        #if len(shape) == 0:
        #    cpp.debug("It's a scalar")
        #    element = ufl.FiniteElement("Quadrature", domain, None)
        #elif len(shape) == 1:
        #    cpp.debug("It's a vector")
        #    element = ufl.VectorElement("Quadrature", domain, None, shape[0])
        #else:
        #    cpp.debug("It's a tensor")
        #    element = ufl.TensorElement("Quadrature", domain, None, shape)
        #cpp.debug("Automatic selection of element: " + str(element))
