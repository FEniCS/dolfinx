...
def _auto_select_element_from_shape(shape, degree=None, cell=None):
    ...
    if degree is None:
        cpp.deprecation("Automatic determination of degree for Expressions", "1.7.0", "1.8.0",
                        "Specify the polynomial degree for interpolation of Expression, or provide a FiniteElemenr")
