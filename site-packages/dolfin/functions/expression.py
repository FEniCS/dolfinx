...
def create_python_derived_expression_class(class_name, user_bases, user_dict):
    ...
    *Arguments*
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Select an appropriate element if not specified
        if element is None:
            element = _auto_select_element_from_shape(self.value_shape(), degree, cell, domain)
        else:
            if not isinstance(element, ufl.FiniteElementBase):
        ...
        # Why do we store the ufl element here in addition to in ufl.Coefficient? It's available as self.ufl_element()...
        self._ufl_element = element
...
def _auto_select_element_from_shape(shape, degree=None, cell=None, domain=None):
    ...
    # Cell checking
    if cell is None and domain is not None:
