...
#@add_metaclass(ExpressionMetaClass) # TODO: Use six.add_metaclass but need newer six on buildbots
class Expression(object):
    ...
    *3. User-defined expressions by subclassing*
    ...
    __metaclass__ = ExpressionMetaClass # TODO: Use six.add_metaclass but need newer six on buildbots
