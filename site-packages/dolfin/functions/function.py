...
#--- Subclassing of ufl.Argument and related classes/functions ---

class Argument(ufl.Argument):
    """UFL value: Representation of an argument to a form.

    Note that this is the PyDOLFIN subclass of the UFL type.
    """
    def __init__(self, V, count=None):
        ...
        ufl.Argument.__init__(self, V.ufl_element(), count)
        self._V = V
...
def Arguments(V):
    ...
    Note that this is the PyDOLFIN variant of the UFL Arguments.
    """
...
def TestFunctions(V):
    ...
    Note that this is the PyDOLFIN variant of the UFL TestFunctions.
    """
    return ufl.split(TestFunction(V))
...
def TrialFunctions(V):
    ...
    Note that this is the PyDOLFIN variant of the UFL TrialFunctions.
    """
    return ufl.split(TrialFunction(V))
