    ...
    *Examples*
    ...
    def __init__(self, *args, **kwargs):
        ...
        if isinstance(args[0], Function):
            other = args[0]
            if len(args) == 1:
                return self.__init_copy_constructor(other)
            elif len(args) == 2:
                i = args[1]
                if not isinstance(i, int):
                    raise TypeError("Invalid subfunction number %s" % (i,))
                return self.__init_subfunction_constructor(other, i)
            else:
    ...
    def __init_cpp_copy_constructor(self, other):
        ...
        ufl.Coefficient.__init__(self, other.function_space().ufl_element(), count=self.id())
    ...
    def __init_subfunction_constructor(self, other, i):
        ...
        ufl.Coefficient.__init__(self, self.function_space().ufl_element(), count=self.id())
