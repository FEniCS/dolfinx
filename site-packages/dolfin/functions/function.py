...
#@add_metaclass(MetaNoEvalOverloading) # TODO: Use six.add_metaclass but need newer six on buildbots
class Function(ufl.Coefficient, cpp.Function):
    ...
    *Examples*
    ...
    __metaclass__ = MetaNoEvalOverloading # TODO: Use six.add_metaclass but need newer six on buildbots
