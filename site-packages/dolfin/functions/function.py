    ...
    *Examples*
    ...
    def __init__(self, *args, **kwargs):
        ...
        if isinstance(args[0], Function):
            if len(args) == 1:
                return self.__init_copy_constructor(args[0])
            elif len(args) == 2:
                if not isinstance(i, int):
                    raise TypeError("Invalid subfunction number %s" % (i,))
                return self.__init_subfunction_constructor(args[0], args[1])
            else:
            ...
            if len(args) == 1:
                ...
                self.__init_cpp_copy_constructor(args[0])
            else:
            ...
            if len(args) == 1:
                ...
                self.__init_from_function_space(args[0])
            elif len(args) == 2:
                ...
                if isinstance(args[1], cpp.Function):
                    self.__init_from_function_space_and_cpp_function(args[0], args[1])
                else:
                    self.__init_from_function_space_and_function(args[0], args[1])
            else:
    ...
    def __init_from_function_space_and_cpp_function(V, other):
