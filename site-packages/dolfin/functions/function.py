...
class Argument(ufl.Argument):
    ...
    def __init__(self, V, number, part=None):
        ...
        # Check argument
        if not isinstance(V, FunctionSpace) and \
           not isinstance(V, cpp.MultiMeshFunctionSpace):
        ...
        # Extract UFL FunctionSpace
        if isinstance(V, FunctionSpace):
            ufl_function_space = V.ufl_function_space()
        else:
            ufl_function_space = V._ufl_function_space

        # Initialize UFL Argument
        ufl.Argument.__init__(self, ufl_function_space, number, part)
