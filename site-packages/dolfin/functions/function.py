...
class Function(ufl.Coefficient, cpp.Function):
    ...
    *Examples*
    ...
    def __float__(self):
        ...
        # Get value directly from vector
        #vec.get_local(values)

        # Call eval to get values
        dim = elm.cell().geometric_dimension()
        x = numpy.zeros(dim, dtype='d') # Not a good solution, this may be outside the domain!
        self.eval(values, x)
