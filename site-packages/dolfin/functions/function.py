...
def _check_mul_and_division(e, linear_comb, scalar_weight=1.0):
    ...
    from ufl.algebra import Division, Product
    ops = e.operands()
...
def _check_and_extract_functions(e, linear_comb=None):
    """
