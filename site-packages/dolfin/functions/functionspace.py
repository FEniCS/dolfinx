...
class FunctionSpace(ufl.FunctionSpace, cpp.FunctionSpace):
    ...
    def _init_from_ufl(self, mesh, element, constrained_domain=None):
        ...
        # FIXME: add count to UFL function space?
        #ufl.FunctionSpace.__init__(self, mesh.ufl_domain(), element, count=self.id())
        ufl.FunctionSpace.__init__(self, mesh.ufl_domain(), element)

    def _init_convenience(self, mesh, family, degree, form_degree=None,
                          constrained_domain=None, restriction=None):
        # FIXME: Do we really want to deprecate this?
        cpp.deprecation("'FunctionSpace(mesh, family, degree)'", "1.7.0", "2.0.0",
                        "Use 'FunctionSpace(mesh, FiniteElement(family, mesh.ufl_cell(), degree))'.")
    ...
    def _init_from_cpp(self, cppV, **kwargs):
        ...
        # FIXME: add count to UFL function space?
        #ufl.FunctionSpace.__init__(self, ufl_domain, ufl_element, count=self.id())
...
def VectorFunctionSpace(mesh, family, degree, dim=None, form_degree=None,
    ...
    *Example of usage*
    ...
    """
    # FIXME: Do we really want to deprecate this?
    cpp.deprecation("'VectorFunctionSpace(mesh, family, degree)'", "1.7.0", "2.0.0",
                    "Use 'FunctionSpace(mesh, VectorElement(family, mesh.ufl_cell(), degree))'.")
...
def TensorFunctionSpace(mesh, family, degree, shape=None, symmetry=None,
    ...
    *Example of usage*
    ...
    """
    # FIXME: Do we really want to deprecate this?
    cpp.deprecation("'TensorFunctionSpace(mesh, family, degree)'", "1.7.0", "2.0.0",
                    "Use 'FunctionSpace(mesh, TensorElement(family, mesh.ufl_cell(), degree))'.")
