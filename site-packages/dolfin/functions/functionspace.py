...
def MultiMeshFunctionSpace(multimesh, family, degree):
    ...
    *Example of usage*
    ...
    V = cpp.MultiMeshFunctionSpace()
    V_parts = [FunctionSpace(multimesh.part(part), family, degree) \
    ...
    # Store UFL function space (not available through cpp.FunctionSpace
    # returned by part())
    V._ufl_function_space = V_parts[0]
