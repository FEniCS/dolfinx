...
class FunctionSpaceBase(cpp.FunctionSpace):
    ...
    def __init__(self, mesh, element, periodic_domain=None):
        ...
        *Arguments*
        ...
        if periodic_domain is not None:
            if not isinstance(periodic_domain, cpp.SubDomain):
                cpp.dolfin_error("functionspace.py",
                                 "create function space",
                                 "Illegal argument, not a subdomain: " + str(periodic_domain))
        ...
        if periodic_domain is None:
            dolfin_dofmap  = cpp.DofMap(ufc_dofmap, mesh)
        else:
            dolfin_dofmap  = cpp.DofMap(ufc_dofmap, mesh, periodic_domain)
...
class UFCFunctionSpace(cpp.FunctionSpace):
    "FunctionSpace represents a finite element function space."
    def __init__(self, mesh, ufc_finite_element, ufc_dofmap, periodic_domain=None):
        ...
        if periodic_domain is None:
            ...
            self._dofmap            = cpp.DofMap(ufc_dofmap, mesh, periodic_domain)
...
class FunctionSpace(FunctionSpaceBase):
    ...
    def __init__(self, mesh, family, degree, form_degree=None,
                 periodic_domain=None, restriction=None):
        """
        ...
        *Examples of usage*
        ...
        FunctionSpaceBase.__init__(self, mesh, element, periodic_domain)
...
class VectorFunctionSpace(MixedFunctionSpace):
    ...
    def __init__(self, mesh, family, degree, dim=None, form_degree=None,
        ...
        *Example of usage*
        ...
        # Initialize base class
        FunctionSpaceBase.__init__(self, mesh, element, periodic_domain=periodic_domain)
