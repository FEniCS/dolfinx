...
#class FunctionSpace(ufl.FunctionSpace, cpp.FunctionSpace): # TODO: Inherit from UFL
...
def FunctionSpaceFromElement(mesh, element, constrained_domain=None):
...
def _create_FunctionSpace(mesh, family, degree, form_degree=None,
        ...
        *Examples of usage*
        ...
        return FunctionSpaceFromElement(mesh, element,
