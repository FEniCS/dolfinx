...
class FunctionSpaceFromCpp(FunctionSpaceBase):
    ...
    def __new__(cls, cppV, element=None):
        ...
        cppV._ufl_element = eval(cppV.element().signature(), ufl.__dict__)
...
class FunctionSpace(FunctionSpaceBase):
    ...
    def __init__(self, mesh, family, degree, form_degree=None,
        ...
        *Examples of usage*
        ...
        # Check for Mesh or Restriction
        mesh = _analyse_mesh_argument(mesh)
        ...
        # These were only used in .restriction() below, disabled because this seems pointless: TODO: Remove
    ...
    def restriction(self, meshfunction):
        space = FunctionSpace(self.mesh(), self.ufl_element().family(), self.ufl_element().degree(),
                              form_degree=self.ufl_element().form_degree())
