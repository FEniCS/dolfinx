        ...
        *Arguments*
        ...
        if constrained_domain is not None:
            if not isinstance(constrained_domain, cpp.SubDomain):
                cpp.dolfin_error("functionspace.py",
                                 "create function space",
                                 "Illegal argument, not a subdomain: " + str(constrained_domain_domain))
...
class EnrichedFunctionSpace(FunctionSpaceBase):
    ...
    def __init__(self, spaces):
        ...
        *Usage*
        ...
        # Initialize base class
        FunctionSpaceBase.__init__(self, spaces[0].mesh(), element, spaces[0].dofmap())
...
class MixedFunctionSpace(FunctionSpaceBase):
    ...
    def __init__(self, spaces):
        ...
        *Examples of usage*
        ...
        # Check that all spaces share same periodic map
