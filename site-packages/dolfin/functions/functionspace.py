...
class FunctionSpace(FunctionSpaceBase):
    ...
    def __init__(self, mesh, family, degree, form_degree=None,
        ...
        *Examples of usage*
        ...
        # Create element
        domain = mesh.ufl_domain() if isinstance(mesh, cpp.Mesh) else mesh.mesh().ufl_domain()
        element = ufl.FiniteElement(family, domain, degree, form_degree=form_degree)
...
class VectorFunctionSpace(MixedFunctionSpace):
    ...
    def __init__(self, mesh, family, degree, dim=None, form_degree=None,
        ...
        *Example of usage*
        ...
        # Create element
        element = ufl.VectorElement(family, domain, degree, dim=dim,
...
class TensorFunctionSpace(FunctionSpaceBase):
    ...
    def __init__(self, mesh, family, degree, shape=None, symmetry=None, \
        ...
        *Example of usage*
        ...
        # Create element
        element = ufl.TensorElement(family, domain, degree, shape, symmetry)
        if restriction is not None:
            element = element[restriction]
