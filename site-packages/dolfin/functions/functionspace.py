...
def MultiMeshFunctionSpace(multimesh, family, degree=None):
    ...
    *Example of usage*
    ...
    and the like must be created via a 'function space constructor',
    as exemplified in the following creation of a multimesh Taylor-Hood
    space.
    ...
    # Create constructor if not supplied
    if callable(family):
        function_space_constructor = family
    else:
        def function_space_constructor(mesh):
    ...
    V_parts = [function_space_constructor(multimesh.part(part)) \
