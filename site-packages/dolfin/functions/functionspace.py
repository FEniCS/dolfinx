...
#class FunctionSpaceBase(ufl.FunctionSpace, cpp.FunctionSpace): # TODO: Inherit from UFL
...
class EnrichedFunctionSpace(FunctionSpaceBase):
    """EnrichedFunctionSpace represents an enriched finite element
function space."""
    ...
    def __init__(self, spaces):
        ...
        *Usage*
        ...
        FunctionSpaceBase.__init__(self, mesh, element,
                                   constrained_domain=constrained_domain)
        # TODO: Make this a function and:
        #return FunctionSpaceBase(mesh, element,
        #                         constrained_domain=constrained_domain)
...
class TensorFunctionSpace(FunctionSpaceBase):
    """TensorFunctionSpace represents a tensor-valued finite element
    function space.
