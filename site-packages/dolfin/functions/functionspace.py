    ...
    def __init__(self, mesh, family, degree, form_degree=None,
        ...
        *Arguments*
            mesh
                a :py:class:`Mesh <dolfin.cpp.Mesh>`.
            family
                a string specifying the element family, see below for
                alternatives.
            degree
                the degree of the element.
            form_degree
                used for FEEC notation.
            restriction
        ...
        *Examples of usage*
            ...
            linear Lagrange element, which is a triangle with nodes at the
            three vertices. Other examples include:

            .. code-block:: python

                # Discontinuous Lagrange element of degree 0
...
class VectorFunctionSpace(MixedFunctionSpace):
    ...
    def __init__(self, mesh, family, degree, dim=None, restriction=None):
        ...
        Use VectorFunctionSpace if the unknown is a vector field, instead of 
        a :py:class:`FunctionSpace 
        <dolfin.functions.functionspace.FunctionSpace>` object for scalar fields.
