...
__date__ = "2007-08-15 -- 2009-10-06"
...
class VariationalProblem(cpp.VariationalProblem):
    ...
    def __init__(self, a, L, bcs = None, cell_domains = None, exterior_facet_domains = None, interior_facet_domains = None, nonlinear = False):
