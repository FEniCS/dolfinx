...
def timed(arg=None):
    ...
    def decorator(func):
        ...
        _task = task or _get_func_name(func)
...
def _get_func_name(func):
    """Return dotted <module.Class.func> name of a function.
    Py2 implementation is a hack. For static function the
    result will not include class name and will not include
    ...
    if hasattr(func, "im_self") and isinstance(func.im_self, type):
        # classmethod
        ...
        # No classname found
        return ".".join((module_name, func_name))

    # Return result with classname
    return ".".join((module_name, class_name, func_name))
