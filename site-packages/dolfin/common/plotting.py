...
def _plot_matplotlib(obj, mesh, kwargs):
    if isinstance(obj, (cpp.MultiMesh, cpp.MultiMeshDirichletBC)):
        cpp.warning("Don't know how to plot type %s" % type(obj))
        return
    if isinstance(obj, cpp.MultiMeshFunction):
        return _plot_matplotlib_multimesh(obj, mesh, **kwargs)
...
def _plot_matplotlib_multimesh(obj, mesh, **kwargs):
