...
class ERK1(cpp.MultiStageScheme):
    """
    ...
    def __init__(self, diff_form, solution, t=None, bcs=None):
        ...
        cpp.MultiStageScheme.__init__(self, stage_forms, last_stage, k, \
                                   solution, t, dt, c, 1,
                                   self.__class__.__name__,
                                   human_form, bcs)

class BDF1(cpp.MultiStageScheme):
    """
...
class ExplicitMidPoint(cpp.MultiStageScheme):
    """
...
class CN2(cpp.MultiStageScheme):
    """
...
class ERK4(cpp.MultiStageScheme):
    """
...
class ESDIRK3(cpp.MultiStageScheme):
    """
...
class ESDIRK4(cpp.MultiStageScheme):
    """
...
__all__ = [name for name, attr in globals().items() \
           if isinstance(attr, type) and issubclass(attr, cpp.MultiStageScheme)]
