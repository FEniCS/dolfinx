...
__all__ = form.__all__ + assembling.__all__ + variationalproblem.__all__ + \
          norms.__all__ + projection.__all__ + interpolation.__all__ + \
          bcs.__all__ + formmanipulations.__all__
