...
__all__ = ["ForwardEuler", "BackwardEuler"]
...
def _butcher_scheme_generator(a, b, c, solution, diff_form):
    ...
    *Arguments*
    ...
    # Stage solutions
    k = [solution.copy() for i in range(size)]
...
class ForwardEuler(cpp.ButcherScheme):
    """
    ...
    def __init__(self, diff_form, solution, t=None, bcs=None):
        ...
        cpp.ButcherScheme.__init__(self, stage_forms, last_stage, k, b, \
                                   solution, t, dt, 1, "ForwardEuler", human_form, bcs)

class BackwardEuler(cpp.ButcherScheme):
    """
    ...
    def __init__(self, diff_form, solution, t=None, bcs=None):
        ...
        stage_forms, last_stage, k, dt, human_form = _butcher_scheme_generator(\
            a, b, c, solution, diff_form)
        cpp.ButcherScheme.__init__(self, stage_forms, last_stage, k, b, \
                                   solution, t, dt, 1, "BackwardEuler", human_form, bcs)
