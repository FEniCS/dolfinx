...
def assemble(form,
    ...
    argument is provided, this will be used instead. If 'reset_sparsity'
    is set to True, the provided tensor will not be reset to zero
    before assembling (adding) values to the tensor.

    Form compiler options can be provided by the 'options' argument.
    """

    # Wrap form
    dolfin_form = Form(form, function_spaces, coefficients, options)
...
def assemble_system(A_form,
    ...
    A_dolfin_form = Form(A_form, A_function_spaces, A_coefficients, options)
    b_dolfin_form = Form(b_form, b_function_spaces, b_coefficients, options)
