...
class Form(cpp.Form):
    ...
    def __init__(self, form, function_spaces=None, coefficients=None, form_compiler_parameters=None):
        ...
        if not hasattr(form, "create_cell_integral"):
            (self._compiled_form, module, self.form_data) = jit(form, form_compiler_parameters)
