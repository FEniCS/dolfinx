...
class Form(cpp.Form):
    def __init__(self, form,
        ...
        # Developer note: The function_spaces argument is used to handle
        # forms defined on multimesh function spaces. These are really
        # defined over a standard function space (the first of the spaces)
        # then later recreated on each function space part and added
        # together to form a multimesh form. This happens in the function
        # assemble_multimesh.
