...
class Form(cpp.Form):
    def __init__(self, form,
        ...
        if not all(( isinstance(c, cpp.GenericFunction)) # or
                   # isinstance(c, cpp.MultiMeshFunction))
                   for c in self.coefficients):
        # Developer note:
        # Not sure if this is of any use any longer, investigate later
        # if all( (not isinstance(c, cpp.GenericFunction)) or
        #         (not isinstance(c, cpp.MultiMeshFunction)
        #          )
        #         for c in self.coefficients):
