    ...
    def __init__(self, form,
        ...
        if isinstance(form, ufl.Form):
            ...
            if mesh is None:
                ...
                if len(domains) == 1:
                    mesh = domains[0].data().get("mesh")
                    # Note: mesh could still be None, depends on what the user did
...
def _extract_subdomains(form_data, override_subdomains):
    ...
    # Temporary hack for getting domain_data from new ufl structure,
    ...
    domain_data = domains[0].data()

    all_subdomains = {}
    for domain_type in domain_types:
        subdomains = override_subdomains.get(domain_type)
        if subdomains is None:
            subdomains = domain_data.get(domain_type)
        ...
        if subdomains is not None:
            ...
            all_subdomains[domain_type] = subdomains
