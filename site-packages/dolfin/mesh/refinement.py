...
__all__ = ["refine", "refine_hierarchy"]
...
def refine_hierarchy(mesh_hierarchy, cell_markers):
    """
    Refine given mesh hierarchy and return the refined mesh hierarchy.

    *Arguments*
        mesh_hierarchy
            the :py:class:`MeshHierarchy <dolfin.cpp.MeshHierarchy>` to be refined.
        cell_markers
            A boolean :py:class:`MeshFunction
            <dolfin.cpp.MeshFunctionBool>` over cells

    *Examples of usage*

        .. code-block:: python

            mh1 = refine_hierarchy(mh0)
    """
    ...
    # Create empty mesh
    refined_mh = cpp.MeshHierarchy()
    # Call C++ refinement
    cpp.refine(refined_mh, mesh_hierarchy, cell_markers)
    return refined_mh
