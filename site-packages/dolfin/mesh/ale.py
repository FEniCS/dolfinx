...
def compute_vertex_map(mesh0, mesh1):
    ...
    *Arguments*
    ...
    vertices0 = mesh0.data().array("parent_vertex_indices")
    vertices1 = mesh1.data().array("parent_vertex_indices")
...
def init_parent_edge_indices(submesh, mesh):
    ...
    if not submesh.data().array("parent_edge_indices") is None:
    ...
    # Create the edge map
    parent_edge_indices = submesh.data().create_array("parent_edge_indices", submesh.num_edges())
