...
def compute_vertex_map(mesh0, mesh1):
    ...
    *Arguments*
    ...
    "global_vertex_indices" which contain a mapping from the
    ...
    vertices0 = mesh0.data().mesh_function("global_vertex_indices")
    vertices1 = mesh1.data().mesh_function("global_vertex_indices")
...
def init_global_edge_indices(submesh, mesh):
    ...
    # Get global vertex numbers
    global_vertex_indices = submesh.data().mesh_function("global_vertex_indices")
