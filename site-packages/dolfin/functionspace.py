...
__date__ = "2008-11-03 -- 2008-12-08"
...
class FunctionSpaceBase(cpp.FunctionSpace):
    ...
    def __init__(self, mesh, element):
        ...
        self.__ufc_element, self.__ufc_dofmap = ffc.jit(self.__element) # UFL: fc.jit, getting fc from global options
...
class FunctionSpaceFromCpp(FunctionSpaceBase):
    ...
    def __init__(self, cppV):
        ...
        print "ffc." + cppV.element().signature()
        self.__element = eval("ffc." + cppV.element().signature())
