...
class MixedSpace(FunctionSpaceBase):
    "MixedSpace represents a mixed finite element function space."
...
class VectorSpace(MixedSpace):
    "VectorSpace represents a vector-valued finite element function space."

    def __init__(self, mesh, family, degree, dim=None):
        """Create vector-valued finite element function space. The function space
        may be created by
        
            V = VectorSpace(mesh, family, domain, degree, dim=None)
        ...
        # Initialize base class
        MixedSpace.__init__(self, spaces)
