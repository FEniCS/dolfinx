...
# Import global parameters (must be done first)
...
from cpp import (has_la_backend, has_mpi, has_slepc, has_scotch, has_cgal,
...
if has_la_backend("PETSc"):
    ...
    from cpp import PETScKrylovMatrix, PETScKrylovSolver
