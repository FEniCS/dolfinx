...
from dolfin import BlockMatrix, BlockVector
...
from dolfin import UnitInterval, Interval, UnitSquare, Rectangle, UnitCircle, UnitCube, Box, UnitSphere
#from dolfin import DofMap, DofMapSet
from dolfin import IntersectionDetector
...
from dolfin import TimeDependent, ODE, ComplexODE
from dolfin import Progress, Timer, Table, Event

# TODO: Don't need these if the typemaps are sorted out. Used for defining constant vector/tensor functions.
from dolfin import ArrayUInt, ArrayDouble
...
# Enums
from dolfin import l1, l2, linf, frobenius
from dolfin import symmetric, nonsymmetric
from dolfin import normalize_l2norm, normalize_average
from dolfin import lu, cg, gmres, bicgstab, default_solver
from dolfin import jacobi, sor, ilu, icc, amg_hypre, amg_ml, default_pc
from dolfin import lagrange, hermite, harmonic
...
try: 
    from dolfin import MTL4Matrix, MTL4Vector, MTL4Factory
except:
    pass
