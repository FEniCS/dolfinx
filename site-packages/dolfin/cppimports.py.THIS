...
from cpp import has_lu_solver_method, list_linear_algebra_backends
from cpp import linear_algebra_backends
from cpp import has_krylov_solver_method, has_krylov_solver_preconditioner
...
# Optional package PETScCusp
if has_linear_algebra_backend("PETScCusp"):
    from cpp import (PETScCuspFactory, PETScCuspFactory_instance)
