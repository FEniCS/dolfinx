...
def _butcher_scheme_generator(a, b, c, time, solution, rhs_form):
    ...
    *Arguments*
    ...
    return ufl_stage_forms, dolfin_stage_forms, last_stage, k, dt, human_form, None
...
def _butcher_scheme_generator_tlm(a, b, c, time, solution, rhs_form, perturbation):
    ...
    *Arguments*
    ...
    return ufl_stage_forms, dolfin_stage_forms, last_stage, stage_solutions, dt, \
           human_form, perturbation
...
class MultiStageScheme(cpp.MultiStageScheme):
    ...
    def __init__(self, rhs_form, solution, t, bcs, a, b, c, order, \
        ...
        ufl_stage_forms, dolfin_stage_forms, last_stage, k, dt, human_form, \
                         contraction = generator(a, b, c, t, solution, rhs_form)
