...
class MultiStageScheme(cpp.MultiStageScheme):
    ...
    def to_tlm(self, y, ydot):
        """
        Return another MultiStageScheme that implements the tangent linearisation of the ODE solver.
        y -- the variable we're perturbing
        ydot -- the perturbation to that variable
        """

        generator = functools.partial(_butcher_scheme_generator_tlm, y=y, ydot=ydot)
        return MultiStageScheme(self._rhs_form, self._solution, self._t, self._bcs, 
