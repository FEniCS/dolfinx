...
def write_entity_meshvaluecollection(ofile, dim, index, value):
    if dim == 0:
        ofile.write("      <value vertex_index=\"%d\" local_entity=\"0\" value=\"%d\"/>\n" % (index, value))
    else:
        ofile.write("      <value cell_index=\"%d\" local_entity=\"0\" value=\"%d\"/>\n" % (index, value))
