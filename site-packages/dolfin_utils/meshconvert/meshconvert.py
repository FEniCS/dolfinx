...
def mesh2xml(ifilename, ofilename):
    ...
    while 1:
        ...
        if  line[0] == "Dimension":
            ...
            num_dims = int(line)
            if num_dims == 2:
                cell_type = b"triangle"
                dim = 2
            elif num_dims == 3:
                cell_type = b"tetrahedron"
                dim = 3
            break
...
def gmsh2xml(ifilename, handler):
    ...
    cell_type_for_dim = {1: b"interval", 2: b"triangle", 3: b"tetrahedron" }
...
class XmlHandler(DataHandler):
    ...
    def __init__(self, ofilename):
        ...
        self.__ofile = open(ofilename, "wb")
    ...
    def start_meshfunction(self, name, dim, size):
        ...
        self.__ofile_meshfunc = open("%s_%s.xml" % (fname, name), "wb")
