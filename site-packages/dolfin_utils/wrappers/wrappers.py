...
def generate_dolfin_classes(prefix, formnames):
    ...
    for fn in formnames:
        for i, name in enumerate(fn.coefficient_names):
            ufc_finite_element_classnames[name] = fn.ufc_finite_element_classnames[i]
            ufc_dof_map_classnames[name] = fn.ufc_dof_map_classnames[i]
...
if __name__ == "__main__":
    uflfilename = "/home/martinal/dev/fenics/ufl/demo/PoissonSystem.ufl" # TODO: Use a relative path to a dolfin demo here
    hfilename = None #"Elasticity.h"
    prefix = "Elast"
    fcprefix = "sfc"
