...
def generate_dolfin_code(prefix, header, form_names, common_space, add_guards):
...
def _generate_dolfin_code_sfc_way(form_datas, header, prefix, fcprefix):
    ...
    return generate_dolfin_code(prefix, header, form_names)
