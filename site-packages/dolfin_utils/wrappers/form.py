...
def generate_form_class(form, classname):
    ...
    (number, name) = generate_coefficient_map_data(form, classname)
    ...
    return code
#-------------------------------------------------------------------------------
def generate_coefficient_map_data(form, classname):
...
dolfin::dolfin_error("generated code for class %s",
                     ...
                     "There are no coefficients")''' % classname
        num  = "\n    %s\n    return 0;" % message
