...
def generate_form_constructor(classname,
                              ...
                              coefficient_set_classname):
    initializerlist = []
    argumentlist = []
    lines = []

    # TODO: Could even derive these names from .ufl files, at least in
    # some cases. Could do the same as with CoefficientSet, make a
    # FunctionSpaceSet? Need reuse across forms!
