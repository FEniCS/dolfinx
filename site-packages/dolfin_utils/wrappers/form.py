...
def generate_form_constructor(classname,
    ...
    if rank:
        ...
        for name in function_space_names:
            if shared_V:
                a = "boost::shared_ptr<const dolfin::FunctionSpace> %s" % name
            else:
                a = "const dolfin::FunctionSpace& %s" % name
    ...
    if include_coefficients:
        ...
        for name in coefficient_names:
            if shared_w:
                a = "boost::shared_ptr<const dolfin::Coefficient> %s" % name
            else:
                a = "const dolfin::Coefficient& %s" % name
            argumentlist.append(a)
