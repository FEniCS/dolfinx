...
public:
  ...
  %(classname)s(const dolfin::Mesh & mesh):
      dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                            ...
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new %(ufc_dof_map_classname)s()), dolfin::reference_to_no_delete_pointer(mesh))))
  {
    // Do nothing
  }
