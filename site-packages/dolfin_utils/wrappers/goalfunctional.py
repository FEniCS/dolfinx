...
attach_domains_template = """
    ...
    %(to)s->cell_domains = %(from)s.cell_domains_shared_ptr();
    %(to)s->interior_facet_domains = %(from)s.interior_facet_domains_shared_ptr();
    %(to)s->exterior_facet_domains = %(from)s.exterior_facet_domains_shared_ptr();
"""
#-------------------------------------------------------------------------------
update_ec_template = """
