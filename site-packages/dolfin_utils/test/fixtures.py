...
def _create_temppath(request):
    ...
    # Construct name test_foo_output from name test_foo.py
    testfilename = os.path.basename(testfile)
    outputname = testfilename.replace(".py", "_output")
    ...
    if MPI.rank(mpi_comm_world()) == 0:
        ...
        if basepath not in _create_temppath._basepaths:
            ...
            # Make sure we have the base path test_foo_output for this test_foo.py file
        ...
        #    shutil.rmtree(path)
        # Make sure we have the path for this test execution: e.g. test_foo_output/test_something__3
