...
def generate_dolfin_namespace(prefix, forms, common_function_space=False):
    ...
    if isinstance(forms, UFCElementNames):
        return generate_single_functionspace(prefix, forms)
...
#-------------------------------------------------------------------------------
def generate_single_functionspace(prefix, space):
    code = generate_functionspace_class("FunctionSpace",
                                        space.ufc_finite_element_classnames,
                                        space.ufc_dof_map_classnames)
    code = "\nnamespace %s\n{\n\n%s\n}" % (prefix, code)
    return code
