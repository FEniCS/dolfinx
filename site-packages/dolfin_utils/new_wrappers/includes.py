...
__all__ = ["dolfin_tag", "stl_includes", "dolfin_includes", "table"]
...
old_table = {"shared_function_space":
         ...
         "shared_mesh":
             {True: ("boost::shared_ptr<const dolfin::Mesh> mesh",
                     "    _mesh = mesh;"),
              False: ("const dolfin::Mesh& mesh",
                      "    _mesh = reference_to_no_delete_pointer(mesh);")
              },
