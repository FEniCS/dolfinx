...
def generate_form_constructors(form, classname):
    ...
    # Generate constructors with not-shared function spaces
    constructors = [generate_constructor(form, classname, False, False, False)]
    if (form.num_coefficients > 0):
        constructors += [generate_constructor(form, classname, False, True, cs)
                         for cs in (False, True)]

    # Generate constructors with shared function spaces
    constructors += [generate_constructor(form, classname, True, False, False)]
    if (form.num_coefficients > 0):
        constructors += [generate_constructor(form, classname, True, True, cs)
                         for cs in (False, True)]
