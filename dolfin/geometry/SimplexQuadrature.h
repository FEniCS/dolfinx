...
public:
  ...
  compute_quadrature_rule(const std::vector<Point>& coordinates,
                          std::size_t gdim, std::size_t order) const;
  ...
  compress(std::pair<std::vector<double>, std::vector<double>>& qr,
           std::size_t gdim, std::size_t quadrature_order);
...
private:
  ...
  // Chebyshev basis
  static Eigen::MatrixXd Chebyshev_Vandermonde_matrix(
  ...
  static std::vector<std::vector<std::size_t>> grlex(std::size_t gdim,
                                                     std::size_t N);
  ...
  static void dunavant_subrule(std::size_t rule, std::size_t suborder_num,
  ...
  static void legendre_compute_glr(std::size_t n, std::vector<double>& x,
                                   std::vector<double>& w);
  static void legendre_compute_glr0(std::size_t n, double& p, double& pp);
  static void legendre_compute_glr1(std::size_t n, std::vector<double>& x,
                                    std::vector<double>& w);
