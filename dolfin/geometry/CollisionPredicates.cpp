						      ...
						      Point point)
{
  ...
  const double tet_det = orient3d(p0,
				  p1,
				  p2,
				  point);
#ifdef augustdebug
							...
							Point b)
{
  ...
  const double rsta = orient3d(r,
			       s,
			       t,
			       a);

  const double rstb = orient3d(r,
			       s,
			       t,
			       b);
...
//-----------------------------------------------------------------------------
double CollisionPredicates::cross_product_norm(Point a, Point b, Point c)
{
