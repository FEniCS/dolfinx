    ...
    std::size_t order) const
{
  ...
  dolfin_assert(quadrature_rule.first.size()
                == gdim * quadrature_rule.second.size());
    ...
    std::size_t order) const
{
  ...
  for (std::size_t i = 0; i < _p.size(); ++i)
  {
    ...
    {
      quadrature_rule.first[d + i * gdim]
          = _p[i][0] * coordinates[0][d] + _p[i][1] * coordinates[1][d]
...
//-----------------------------------------------------------------------------
std::vector<std::size_t> SimplexQuadrature::compress(
    std::pair<std::vector<double>, std::vector<double>>& qr, std::size_t gdim,
...
void SimplexQuadrature::setup_qr_reference_tetrahedron(std::size_t order)
{
  ...
  case 4:
    ...
    _w = {-0.0789333333333330, 0.0457333333333335, 0.0457333333333335,
          0.0457333333333335,  0.0457333333333335, 0.1493333333333332,
          0.1493333333333332,  0.1493333333333332, 0.1493333333333332,
          0.1493333333333332,  0.1493333333333332};
  ...
  case 5:
    // Assign weights
    _w = {0.0734930431163618, 0.0734930431163618, 0.0734930431163618,
          0.0734930431163618, 0.1126879257180158, 0.1126879257180158,
          0.1126879257180158, 0.1126879257180158, 0.0425460207770813,
          0.0425460207770813, 0.0425460207770813, 0.0425460207770813,
          0.0425460207770813, 0.0425460207770813};
  ...
  case 6:
    // Assign weights
    _w = {0.0399227502581678, 0.0399227502581678, 0.0399227502581678,
          0.0399227502581678, 0.0100772110553205, 0.0100772110553205,
          0.0100772110553205, 0.0100772110553205, 0.0553571815436550,
          0.0553571815436550, 0.0553571815436550, 0.0553571815436550,
          0.0482142857142855, 0.0482142857142855, 0.0482142857142855,
          0.0482142857142855, 0.0482142857142855, 0.0482142857142855,
          0.0482142857142855, 0.0482142857142855, 0.0482142857142855,
          0.0482142857142855, 0.0482142857142855, 0.0482142857142855};
    ...
    std::size_t gdim, std::size_t N)
{
  ...
  for (std::size_t d = 0; d < gdim; ++d)
  {
    ...
    const Eigen::VectorXd xmap
        = (2. / hx) * x
          - ((xmin + xmax) / hx) * Eigen::VectorXd::Ones(x.size());
...
SimplexQuadrature::Chebyshev_polynomial(const Eigen::VectorXd& x, std::size_t N)
{
...
//-----------------------------------------------------------------------------
std::vector<std::vector<std::size_t>> SimplexQuadrature::grlex(std::size_t gdim,
                                                               std::size_t N)
{
...
//-----------------------------------------------------------------------------
std::size_t SimplexQuadrature::choose(std::size_t n, std::size_t k)
{
                                      ...
                                      std::vector<double>& w)
{
  ...
  ;
  const std::vector<std::size_t> suborder
      = dunavant_suborder(rule, suborder_num);
...
std::vector<std::size_t> SimplexQuadrature::dunavant_suborder(int rule,
                                                              int suborder_num)
...
//-----------------------------------------------------------------------------
void SimplexQuadrature::dunavant_subrule_01(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_02(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_03(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_04(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_05(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_06(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_07(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_08(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_09(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_10(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_11(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_12(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_13(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_14(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_15(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_16(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_17(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_18(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_19(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::dunavant_subrule_20(int suborder_num,
                                            std::vector<double>& suborder_xyz,
                                            std::vector<double>& suborder_w)
...
void SimplexQuadrature::legendre_compute_glr0(std::size_t n, double& p,
                                              double& pp)
...
void SimplexQuadrature::legendre_compute_glr2(double pn0, int n, double& x1,
                                              double& d1)
