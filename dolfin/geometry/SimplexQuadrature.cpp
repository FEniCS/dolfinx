                                                    ...
                                                    std::size_t order)
{
  ...
  case 3:
    {
      det = tools::area({{coordinates[0], coordinates[1], coordinates[2]}});
...
//-----------------------------------------------------------------------------
// FIXME: Functions below should be removed and replaced by functions above
// FIXME: that take vector<Point> instead of a flattened array.
//-----------------------------------------------------------------------------
std::pair<std::vector<double>, std::vector<double>>
