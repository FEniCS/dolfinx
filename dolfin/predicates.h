...
inline double narrowdoublerand()
{
  double result;
  double expo;
  long a, b, c;
...
inline double uniformdoublerand()
{
  double result;
  long a, b;
...
inline REAL insphereadapt(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe, REAL permanent)
/* REAL *pa; */
/* REAL *pb; */
/* REAL *pc; */
/* REAL *pd; */
