...
//-----------------------------------------------------------------------------
void uBLASVector::get_local(double* block, std::size_t m, const std::size_t* rows) const
{
...
//-----------------------------------------------------------------------------
void uBLASVector::gather(GenericVector& x, const std::vector<std::size_t>& indices) const
{
...
//-----------------------------------------------------------------------------
void uBLASVector::gather(std::vector<double>& x, const std::vector<std::size_t>& indices) const
{
  not_working_in_parallel("uBLASVector::gather)");
...
//-----------------------------------------------------------------------------
void uBLASVector::set(const double* block, std::size_t m, const std::size_t* rows)
{
  for (std::size_t i = 0; i < m; i++)
    (*x)(rows[i]) = block[i];
}
//-----------------------------------------------------------------------------
void uBLASVector::add(const double* block, std::size_t m, const std::size_t* rows)
{
  for (std::size_t i = 0; i < m; i++)
    (*x)(rows[i]) += block[i];
}
