...
#ifndef __UNASSEMBLED_MATRIX_H
#define __UNASSEMBLED_MATRIX_H
...
namespace dolfin
{
  ...
  class UnassembledMatrix : public GenericMatrix
  {
  public:
    ...
    virtual UnassembledMatrix* copy() const;
    ...
    /// Finalize assembly of tensor. The mode parameter is not used 
    ...
    virtual const UnassembledMatrix& operator*= (double a);
    ...
    /// Assignment operator
    const UnassembledMatrix& operator= (const UnassembledMatrix& A);
