...
{
  tol = ode.get("ODE tolerance").get_real();
  _kmax  = ode.get("ODE maximum time step").get_real();
  beta   = ode.get("ODE interval threshold").get_real();
  safety =  ode.get("ODE safety factor").get_real();
