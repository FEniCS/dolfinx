...
//-----------------------------------------------------------------------------
int SaxHandler::parse_int(const xmlChar* name, const xmlChar** attrs,
...
//-----------------------------------------------------------------------------
unsigned int SaxHandler::parse_uint(const xmlChar* name, const xmlChar** attrs,
					                          const char* attribute)
{
  // Check that we got the data
  if ( !attrs )
...
//-----------------------------------------------------------------------------
double SaxHandler::parse_float(const xmlChar* name, const xmlChar** attrs,
			                         const char* attribute)
{
  // Check that we got the data
  if ( !attrs )
...
//-----------------------------------------------------------------------------
std::string SaxHandler::parse_string(const xmlChar* name, const xmlChar** attrs,
				                             const char* attribute)
{
  // Check that we got the data
  if ( !attrs )
