                                        ...
                                        std::size_t dim, const unsigned int* v) const
{
  ...
  case 1:
    ...
    e[8][0]  = v[1]; e[8][1]  = v[2];
    e[9][0]  = v[0]; e[9][1]  = v[4];
    e[10][0] = v[0]; e[10][1] = v[3];
    e[11][0] = v[0]; e[11][1] = v[1];
    break;
  case 2:
    // Resize data structure
    ...
    // Create the 6 faces
    e[0][0] = v[4]; e[0][1] = v[5]; e[0][2] = v[6]; e[0][3] = v[7];
    e[1][0] = v[2]; e[1][1] = v[3]; e[1][2] = v[7]; e[1][3] = v[6];
    e[2][0] = v[1]; e[2][1] = v[2]; e[2][2] = v[6]; e[2][3] = v[5];
    e[3][0] = v[0]; e[3][1] = v[3]; e[3][2] = v[7]; e[3][3] = v[4];
    e[4][0] = v[0]; e[4][1] = v[1]; e[4][2] = v[5]; e[4][3] = v[4];
    e[5][0] = v[0]; e[5][1] = v[1]; e[5][2] = v[2]; e[5][3] = v[3];
    break;
  default:
    dolfin_error("HexahedronCell.cpp",
