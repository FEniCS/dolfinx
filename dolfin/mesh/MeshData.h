...
namespace dolfin
{
  ...
  /// Boundary extraction
  ///
  ///   * (removed, is now a member function is BoundaryMesh) "vertex map" - _MeshFunction_ <uint> of dimension 0
  ///   * (removed, is now a member function is BoundaryMesh) "cell map"   - _MeshFunction_ <uint> of dimension D
  ///
  ///
  /// Mesh partitioning
  ///
