...
def generate_docstrings():
    ...
    from generateswigcode import copyright_form_swig

    # Set copyright form
    copyright_form_swig["holder"] = "Kristian B. Oelgaard"
    ...
    print "Generating docstrings from intermediate representation module..."
    for module in documentation:
        output_file = open(os.path.join(module, "docstrings.i"), "w")
