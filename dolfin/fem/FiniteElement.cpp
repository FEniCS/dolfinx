...
//-----------------------------------------------------------------------------
FiniteElement* FiniteElement::extract_sub_element(const std::vector<uint>& component) const
{
  // Recursively extract sub element
  FiniteElement* sub_finite_element = extract_sub_element(*this, component);
                                                  ...
                                                  const std::vector<uint>& component)
{
  ...
  // Create sub system
  FiniteElement* sub_element = finite_element.create_sub_element(component[0]);
  ...
  FiniteElement* sub_sub_element = extract_sub_element(*sub_element, sub_component);
  delete sub_element;
