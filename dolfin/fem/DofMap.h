...
namespace dolfin
{
  ...
  public:
    ...
    const std::vector<std::size_t>& cell_dofs(std::size_t cell_index) const
    {
    ...
    const std::vector<std::vector<std::size_t> >& data() const
    { return _dofmap; }
  ...
  private:
    ...
    std::vector<std::vector<std::size_t> > _dofmap;
