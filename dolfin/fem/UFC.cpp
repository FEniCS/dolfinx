...
//-----------------------------------------------------------------------------
UFC::UFC(const Form& form) : form(*form.ufc_form()), cell(form.mesh(), false),
  cell0(form.mesh(), false), cell1(form.mesh(), false),
...
//-----------------------------------------------------------------------------
UFC::UFC(const UFC& ufc) : form(ufc.form), cell(ufc.dolfin_form.mesh(), false),
   cell0(ufc.dolfin_form.mesh(), false), cell1(ufc.dolfin_form.mesh(), false),
