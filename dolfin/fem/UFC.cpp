...
void UFC::init(const Form& form)
{
  ...
  if (cell_integrals.size())
    default_cell_integral = cell_integrals[0]; // FIXME REMOVE AFTER DEFAULT INTEGRALS ARE GENERATED BY FFC
  ...
  if (exterior_facet_integrals.size())
    default_exterior_facet_integral = exterior_facet_integrals[0]; // FIXME REMOVE AFTER DEFAULT INTEGRALS ARE GENERATED BY FFC
  ...
  if (interior_facet_integrals.size())
    default_interior_facet_integral = interior_facet_integrals[0]; // FIXME REMOVE AFTER DEFAULT INTEGRALS ARE GENERATED BY FFC
