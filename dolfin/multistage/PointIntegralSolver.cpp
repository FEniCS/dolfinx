						...
						const Cell& cell)
{
  ...
  // slow. 
  // NOTE: Here we assume the restricted form coefficients
  // NOTE: contains the correct values, which they do as we have called 
  // NOTE: update before entering this method.
  for (unsigned int row=0; row < _system_size; row++)
  {
