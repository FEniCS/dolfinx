...
from dolfin import *
import os
from dolfin_utils.test import skip_if_not_exodus, fixture, cd_temppath

@skip_if_not_exodus
def test_save_1d_mesh(cd_temppath):
    """Test output of 1D Mesh to Exodus file"""
    mesh = UnitIntervalMesh(32)
    File("mesh.e") << mesh

@skip_if_not_exodus
def test_save_2d_mesh(cd_temppath):
    """Test output of 2D Mesh to Exodus file"""
    mesh = UnitSquareMesh(32, 32)
    File("mesh.e") << mesh

@skip_if_not_exodus
def test_save_3d_mesh(cd_temppath):
    """Test output of 3D Mesh to Exodus file"""
    mesh = UnitCubeMesh(8, 8, 8)
    File("mesh.e") << mesh

@skip_if_not_exodus
def test_save_1d_scalar(cd_temppath):
...
@skip_if_not_exodus
def test_save_2d_scalar(cd_temppath):
...
@skip_if_not_exodus
def test_save_3d_scalar(cd_temppath):
...
@skip_if_not_exodus
def test_save_2d_vector(cd_temppath):
...
@skip_if_not_exodus
def test_save_3d_vector(cd_temppath):
...
@skip_if_not_exodus
def test_save_2d_tensor(cd_temppath):
...
#@skip_if_not_exodus
#def test_save_3d_tensor(cd_temppath):
#    mesh = UnitCubeMesh(8, 8, 8)
#    u = Function(TensorFunctionSpace(mesh, "Lagrange", 2))
#    u.vector()[:] = 1.0
#    File("u.e") << u
